...
const list2 = [
  ...
  "Advanced Anti-Pest Removal Solutions",
...
const leftFeature = [
  {
    ...
    desc: "Advanced detection identifies pest removal activity before major structural damage occurs.",
  },
  {
    heading: "Prevent Future Damage",
    desc: "Protect your investment with long-lasting pest removal prevention treatments.",
  },
];

const rightFeature = [
  {
    heading: "Safe & Pest-Removal",
...
const cards = [
  {
    heading: "Comprehensive Pest Removal Protection",
  ...
  },
  {
    ...
    desc: "Protect your property from costly pest removal damage with preventive care.",
...
const faqs = [
  ...
  {
    id: "02",
    question: "How long does pest removal treatment take?",
    answer:
      "Most pest removal pest removal treatments are completed within a few hours, depending on the size of the property and the severity of infestation.",
  },
  {
    id: "03",
    question: "Is pest removal treatment safe for children and pets?",
    answer:
      "Yes. Orion uses government-approved pest removal treatment solutions that are safe when applied by certified professionals.",
  },
  {
    id: "04",
    question: "How long does pest removal protection last?",
    answer:
      "Our treatments provide long-term protection, and preventive maintenance can significantly extend effectiveness.",
  },
  {
    id: "05",
    question: "Do you provide pest removal warranties?",
    answer:
      "Yes. Selected pest removal treatment plans include service warranties for additional peace of mind.",
  },
  {
    id: "06",
    question: "How much does pest removal treatment cost?",
    answer:
...
export default function page() {
  return (
    <div className="w-full">
      ...
      <HeroSection
        image="/Images/services/fast.png"
        ...
        heading={
          <>
            <h1 className="text-4xl sm:text-5xl xl:text-7xl font-bold text-[#36388D] leading-tight lg:!leading-[4.5rem]">
              ...
              <br />
              <span className="text-[#1095D9]">Pest Removal</span>
            </h1>
          </>
        }
        ...
        heading={
          <>
            <h2 className="text-4xl sm:text-5xl xl:text-6xl font-bold text-[#36388D] w-full leading-tight">
              Advanced Pest Removal Control for
      ...
      heading={
        ...
        desc="Our comprehensive pest removal control process protects every vulnerable area of your property, ensuring complete structural safety and long-lasting defense against ants."
        list={list2}
      ...
      <Diagram
        ...
        heading={
          ...
          <h2 className="text-4xl sm:text-5xl xl:text-6xl font-bold text-[#2F3293] leading-tight lg:!leading-[3.9rem] mt-10">
            Complete Pest Removal Control
            <br />
            <span className="text-[#0094DA]">at Every Place.</span>
          </h2>
          </>
        }
        desc="Whether it's a home, office, warehouse, hotel, or commercial building, our specialized pest removal treatment keeps every property protected against hidden pest removal attacks."
      ...
      <TestimonialsSection
        heading={
          ...
          <h2 className="mt-4 text-4xl sm:text-5xl xl:text-6xl font-bold text-[#2F3293] leading-tight">
            ...
            <br />
            <span className="text-[#0094DA]">Pest Removal Free,</span>{" "}
            <span className="text-[#2F3293]">Every Time.</span>
          </h2>
          </>
        }
        desc="See why homeowners, businesses, and builders trust Orion Pest Control for dependable pest removal protection and exceptional service."
      />
          ...
          <div className="grid gap-12 lg:grid-cols-2 items-start">
            ...
            <div>
              ...
              <h2 className="mt-4 text-4xl md:text-6xl font-bold leading-tight text-[#2F3293]">
                ...
                <br />
                <span className="text-[#2F3293]">Pest Removal-Free.</span>
              </h2>
              ...
              <p className="mt-4 max-w-lg text-base sm:text-lg leading-relaxed text-gray-600">
                ...
                damage. Book a professional pest removal inspection with our
