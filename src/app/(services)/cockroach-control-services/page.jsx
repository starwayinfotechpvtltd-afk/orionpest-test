...
//       setError("Please enter your postcode/location");
//       return;
//     }
...
//                     key={index}
//                     onClick={() => setCurrent(index)}
//                     className={`w-3 h-3 rounded-full transition-all duration-300 ${current === index ? "bg-blue-700" : "bg-gray-300"
//                       }`}
//                   />
//                 ))}
//               </div>
...
import { GrShieldSecurity, GrUserWorker } from "react-icons/gr";
import { LuLeaf, LuShieldCheck, LuCalendarDays } from "react-icons/lu";
import { BiSolidPhoneCall, BiSolidRightArrowAlt } from "react-icons/bi";
import {
  FaCalendarWeek,
  FaRegSmile,
  FaSink,
...
import { IoIosArrowDown } from "react-icons/io";
import ImageSlider from "@/components/ui/ImageSlider";
import { getPageData } from "@/lib/getPageData"; // Ensure you have this if used in metadata (remove if doing client-only without metadata)
...
export default function Page() {
  ...
  const process = [
    {
      ...
      heading: "Inspection",
      subHeading:
        "Our experts inspect your property to identify the infestation level.",
    },
    {
      icon: <IoBugSharp />,
      heading: "Identification",
    ...
    },
    {
      ...
      heading: "Treatment",
      subHeading:
        "Safe & effective treatment using advanced equipment and methods.",
    },
    {
      icon: <LuShieldCheck />,
      heading: "Prevention",
  ...
  const testimonials = [
    {
      text: "Heard about this company and tried it was very professional and the chemicals used were odourless which is a perfect definition of good quality chemicals and the result was visible in first attempt. Really impressed and I’ll definitely recommend my friends to opt for this company if they are facing any pest related issues.",
      name: "Sivani Rao",
    },
    {
      text: "It's the best pest control company in Kolkata. Very supportive staff and prompt service every time. A PAN India company and extremely good support received not only in Kolkata but in other states as well. Highly recommended.",
  ...
  async function handleSubmit(e) {
    ...
    // Service Validation
    if (!form.service.trim() || form.service === "Select Service") {
      setError("Please select a service");
      return;
    }
  ...
  return (
    <div className="w-full">
      ...
      >
        <div className="flex flex-col lg:flex-row items-center justify-between max-w-[80%] mx-auto py-20">
          <div className="space-y-5 w-full">
            ...
            <p className="text-xl">
              Get rid of cockroaches completely with Orion's safe, effective, and eco-friendly treatment. As a top provider of{" "}
              <Link href="https://www.orionpest.com" className="text-blue-700 font-semibold hover:underline">
                pest control services
              </Link>
              , we bring over 27+ years of experience, proudly serving 5K+ Businesses since 1998.
            </p>
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 items-center md:gap-5 mt-4">
              {points.map((item, index) => (
                <div
                  className="flex flex-col gap-2 items-center w-32 justify-center"
                  key={index}
            ...
            <div className="flex flex-col md:flex-row items-center gap-5 justify-center lg:justify-start mt-6">
              <Link
                className="bg-[#042990] flex items-center justify-center md:justify-start gap-3 px-3 py-2 rounded w-60 md:w-56 relative"
                href={"tel:1800 419 8181"}
              >
          ...
          <div id="form-section" className="rounded-2xl mt-10 lg:mt-0 w-[100%] md:w-[500px]">
            <div className="bg-[#042990] rounded-t-2xl p-5 text-center">
              {/* Changed to H3 */}
            ...
            <form
              className="p-6 space-y-3 bg-white rounded-b-2xl shadow-xl"
              onSubmit={handleSubmit}
            >
              <input
                type="text"
              ...
              <select
                ...
                id="services"
                value={form.service}
                className="border border-gray-300 rounded p-3 pl-5 w-full text-gray-600"
                onChange={(e) => setForm({ ...form, service: e.target.value })}
              >
              ...
              <button
                className="bg-[#F2C31C] text-[#042990] py-2 w-full uppercase mt-5 rounded font-bold text-md flex items-center justify-center transition hover:bg-yellow-500"
                disabled={loading}
              >
                <div>
                  {loading && (
                    <svg
                      className="mr-3 h-5 w-5 animate-spin text-[#042990] inline"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                    >
              ...
              <p className="text-center text-[#042990] font-semibold text-sm">
                Your information is safe with us
              </p>
            </form>
          </div>
      ...
      <div className="py-20 max-w-[80%] mx-auto">
        ...
        {/* H2 #1 */}
        <h2 className="text-[#042990] text-center text-4xl font-bold mt-2">
          Signs You May Need Cockroach Pest Control
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-6 items-center justify-between gap-5 2xl:gap-10 mt-10">
          {signs.map((item, index) => (
            <div
              className="p-5 2xl:p-10 shadow-lg rounded-xl flex flex-col justify-between items-center gap-5 w-full h-32 md:h-48 xl:h-56 bg-white border border-gray-100"
              key={index}
            >
              <div className="p-5 bg-[#FFE977] border border-[#FED739] rounded-full w-18 h-18 flex justify-center items-center text-4xl">
                {item.icon}
      ...
      <div className="w-full bg-[#F2C31C] py-10">
        {/* H3 #2 */}
        <h3 className="text-[#042990] text-4xl md:text-5xl font-extrabold text-center">
          Our Clients
        </h3>
        <ImageSlider />
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between max-w-[80%] mx-auto mt-20">
        <div className="space-y-5 lg:w-1/2">
          <p className="text-[#D4141A] text-lg font-semibold">Why It Matters</p>
          {/* H3 #3 */}
          <h3 className="text-[#042990] text-4xl lg:text-5xl font-extrabold leading-tight">
            Why Cockroaches <br />{" "}
            <span className="text-[#D4141A]">Are Dangerous</span>
          </h3>
          <p className="text-xl text-gray-700">
            Cockroaches are not just unpleasant; they can cause serious health
            problems and property damage. Ensure the safety of your home with our specialized{" "}
            <Link href="https://www.orionpest.com/residential-pest-control/" className="text-blue-700 font-semibold hover:underline">
          ...
          <ul className="space-y-3 mt-4">
            <li className="flex items-center gap-4 text-lg">
              <FaCircleCheck className="shrink-0" color="#042990" />
              Spread bacteria like Salmonella and E.coli
            </li>
            <li className="flex items-center gap-4 text-lg">
              <FaCircleCheck className="shrink-0" color="#042990" />
            ...
            <li className="flex items-center gap-4 text-lg">
              <FaCircleCheck className="shrink-0" color="#042990" />
              Reproduce quickly and are hard to eliminate without cockroach pest control
            </li>
          </ul>
        </div>
        <div className="w-[100%] md:w-[500px] lg:w-[45%] h-[300px] md:h-[400px] relative mt-10 lg:mt-0">
          <Image
            src={"/Images/bugs/cockroach1.jpeg"}
      ...
      {/* Our process */}
      <div className="w-full bg-[#FDD319] py-16 mt-20">
        <div className="max-w-[80%] mx-auto">
          <p className="text-[#D4141A] text-lg font-semibold text-center uppercase tracking-wide">
            Our Process
          </p>
          {/* H2 #2 */}
          <h2 className="text-[#042990] text-4xl md:text-5xl font-extrabold text-center mt-2">
            Our Cockroach Pest Control Service Process
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 justify-between items-start mt-12 relative gap-8 lg:gap-4">
            {process.map((item, index) => (
              <div
                key={index}
                className="relative flex flex-col items-center w-full"
              >
                ...
                {/* Connector Line */}
                {index !== process.length - 1 && (
                  <div className="absolute top-10 left-[60%] w-[80%] hidden lg:flex items-center z-0">
                    <div className="border-t-2 border-dashed border-[#042990] w-full"></div>
                    <BiSolidRightArrowAlt className="text-[#042990] text-2xl -ml-2" />
                  </div>
                )}

                {/* Number Circle */}
                <div className="bg-[#042990] w-8 h-8 rounded-full flex items-center justify-center text-white text-sm font-semibold mt-4 shadow">
                  {index + 1}
                </div>

                {/* Title */}
                <h3 className="text-[#042990] font-bold text-xl mt-3 text-center">
                  {item.heading}
                </h3>

                {/* Description */}
                <p className="text-center text-sm md:text-base text-gray-800 mt-2 px-2">
                  {item.subHeading}
                </p>
              </div>
            ))}
      ...
      <div className="w-full bg-[#F9F8FA]">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center justify-between max-w-[80%] mx-auto py-20">
          {/* Left Side */}
          <div>
            <p className="text-red-500 font-bold uppercase text-lg mb-2">
              Why Choose Orion Pest Solutions?
            ...
            <p className="text-gray-700 mb-6 text-lg">
              ...
              across the nation or dedicated{" "}
              <Link href="https://www.orionpest.com" className="text-blue-700 font-semibold hover:underline">
                Pest Control Services Kolkata
              </Link>
              , our verified experts deliver unmatched results.
            </p>
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={index} className="flex items-start gap-3">
                  <FaCircleCheck className="w-6 h-6 text-[#042990] shrink-0 mt-0.5" />
          ...
          <div className="flex justify-center mt-10 md:mt-0">
            <div className="relative bg-white rounded-2xl shadow-xl p-8 max-w-lg w-full text-center min-h-[340px] flex flex-col justify-center transition-all duration-500 border border-gray-100">
              {/* Quote Circle */}
              <div className="absolute -top-8 left-1/2 -translate-x-1/2 w-16 h-16 rounded-full bg-yellow-400 flex items-center justify-center text-blue-900 text-3xl font-bold shadow-md">
                <FaQuoteLeft />
              </div>

              <p
                key={current}
                className="text-blue-900 font-medium leading-relaxed mt-6 text-lg md:text-xl animate-fade"
              >
                "{testimonials[current].text}"
              </p>

              <div className="mt-6 text-[#FDD319] text-2xl tracking-widest">★★★★★</div>

              <h4 className="mt-4 font-bold text-blue-900 text-lg uppercase tracking-wide">
                - {testimonials[current].name}
              </h4>
              ...
              <div className="flex justify-center gap-3 mt-6">
                {testimonials.map((_, index) => (
                  <button
                    ...
                    className={`w-3 h-3 rounded-full transition-all duration-300 ${
                      current === index ? "bg-blue-700 scale-125" : "bg-gray-300 hover:bg-gray-400"
                    }`}
                  />
                ))}
              </div>
      ...
      <div className="w-full bg-[#FDD319] py-20">
        <div className="w-[80%] mx-auto">
          {/* H3 #5 */}
          <h3 className="mb-12 text-[#042990] text-4xl md:text-5xl font-extrabold text-center">
            Membership & Certification
          </h3>
          <div className="flex flex-wrap gap-10 items-center justify-center">
            {certifictions.map((image) => (
              ...
              >
                <Image
                  ...
                  fill
                  className="transition duration-300 ease-in-out hover:-translate-y-2 hover:scale-110 object-contain drop-shadow-md"
                />
              </div>
            ))}
          </div>
      ...
      <div className="w-full bg-white">
        <div className="py-24 max-w-[80%] mx-auto">
          <p className="text-center text-red-500 font-bold uppercase text-lg tracking-wider">
            Frequently Asked Questions
          </p>

          {/* H3 #6 */}
          <h3 className="text-center text-4xl md:text-5xl font-extrabold text-blue-900 mt-3 mb-12">
            FAQs
          </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {faqData.map((faq) => (
              <div
                key={faq.id}
                className="w-full border border-gray-200 rounded-xl bg-gray-50 shadow-sm overflow-hidden self-start hover:shadow-md transition-shadow"
              >
                <button
                  onClick={() => toggleFaq(faq.id)}
                  className="w-full flex items-center justify-between px-6 py-5 text-left font-bold text-gray-800 focus:outline-none"
                >
                ...
                >
                  <div className="px-6 pb-6 text-gray-700 text-base leading-relaxed border-t border-gray-200 pt-4">
                    {faq.answer}
                  </div>
                </div>
              </div>
