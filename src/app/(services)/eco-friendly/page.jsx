  ...
  return (
    <div className="w-full">
      ...
      <HeroSection
        ...
        desc="Protect your home from hidden eco friendly damage with Orion Pest Control. Our advanced eco friendly treatment solutions eliminate active infestations and provide long-lasting protection for homes, offices, and commercial properties. Safe, effective, and trusted since 1998."
        ...
        desc={
          <>
            <p className="text-gray-600 text-sm sm:text-base md:text-lg leading-relaxed sm:leading-8 mt-4">
              Our eco-friendly eco friendly treatments provide maximum protection while remaining safe for your children, pets, and the environment. Enjoy complete peace of mind without compromising your family's safety.
            </p>
            <br />
          </>
        }
