...
export const metadata = {
  title: "Pest Control Company in Patna | 27+ Years of Trusted Pest Services - Orion Pest",
  description:
    "Looking for the top pest control company in Patna? Orion Pest Solutions provides safe, odorless pest control services, termite control, cockroach removal & rodent defense across Patna. 27+ years of trust. Book a free inspection today!",
};
...
const services = [
  {
    ...
    description: "Specialized cockroach control in Patna with odorless gel baits and targeted sprays for modular kitchens and commercial pantries.",
  ...
  },
  {
    ...
    description: "Advanced pre & post-construction termite control in Patna safeguarding wooden interiors, door frames, and flooring.",
...
const protectionFeatures = [
  ...
  },
  {
    ...
    description:
      "Our technicians in Patna are certified, background-verified, and trained in modern pest management.",
    icon: UserCheck,
  },
  {
...
const faq = [
  {
    id: "01",
    question: "Why should I choose Orion Pest Solutions in Patna?",
    answer:
      "Orion Pest Solutions is an established pest control company in Patna with over two decades of industry experience. We offer government-approved, low-toxicity treatments, certified local technicians, and guaranteed results tailored to Patna's climate conditions.",
  },
  {
    id: "02",
    question: "How does your cockroach control in Patna work?",
    answer:
  ...
  {
    id: "03",
    question: "When is the right time to get termite control in Patna?",
    answer:
      "Subterranean termites are active throughout the year in Patna. If you notice mud tubes along walls, hollow-sounding wooden doors, or fine wood dust, you should book a termite inspection immediately.",
  },
  {
    id: "04",
  ...
  },
  {
    ...
    answer:
      "We serve all major localities across Patna, including Kankarbagh, Boring Road, Bailey Road, Patliputra Colony, Rajendra Nagar, Danapur, Fraser Road, Ashiana Nagar, and Anisabad.",
  },
];
            ...
            <div className="w-full space-y-8">
              ...
              <div className="space-y-2">
                <h1 className="text-[34px] sm:text-5xl w-full md:w-2xl xl:text-7xl font-bold text-[#36388D] leading-tight lg:!leading-[4.8rem]">
                  ...
                  <span className="text-[#1095D9]"> Patna </span>
                </h1>
                <div className="h-[2px] w-28 bg-amber-300"></div>
              </div>

              <p className="text-lg sm:text-xl text-gray-700 font-medium leading-relaxed">
                Looking for a trusted pest control company in Patna? Orion Pest Solutions offers safe, fast, and eco-friendly pest control services across Patna. From residential homes in Kankarbagh and Boring Road to commercial complexes along Bailey Road and Patliputra, we ensure complete pest relief.
              </p>
        ...
        <div className="w-full bg-[#FDC82A] p-10 flex flex-col justify-center items-center space-y-10">
          <div className="w-[400px] md:w-[500px] h-[400px] xl:w-[600px] xl:h-[500px] relative">
            <Image
              ...
              alt="Pest control company in Patna"
              fill
        ...
        <div className="w-full space-y-5 py-12 md:py-20 px-6 sm:px-10 md:px-16 lg:px-20">
          ...
          <div className="space-y-3">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-[#0D2391] font-bold leading-tight">
              ...
              <span className="text-[#FECE18]">in Patna</span>
            </h2>
          </div>
          <div className="bg-[#0D2391] h-[5px] w-28 rounded"></div>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Patna's dense urban sprawl, riverine climate, and humid monsoon months create active breeding zones for common household and commercial pests. Subterranean termites cause severe structural damage to wooden door frames, wardrobes, and furniture, while cockroaches and rodents proliferate in kitchens, commercial markets, and residential apartments.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            As a leading pest control company in Patna, Orion Pest Solutions brings over 27 years of proven industry experience to your property. We locate root nesting colonies, apply odorless, government-approved formulations, and establish deep chemical barriers so pests don't return. Whether you need reliable cockroach control in Patna or comprehensive termite control in Patna, our certified local team ensures clean, long-lasting results.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Our complete suite of pest control services in Patna protects independent houses, apartments, restaurants, hospitals, and commercial offices with transparent pricing and service warranties.
          </p>
          <Link
            href={"/about"}
          ...
          <div className="grid overflow-hidden rounded-[28px] lg:grid-cols-[1fr_1fr]">
            ...
            <div className="relative z-10 bg-white py-8 pr-0 sm:py-10 lg:py-12 lg:pr-10 xl:py-14">
              ...
              <p className="max-w-2xl leading-[1.65] text-gray-700">
                Orion Pest Solutions is an established pest control company in Patna dedicated to keeping homes, housing societies, and commercial premises pest-free. Our certified technicians combine scientific pest management, eco-friendly formulations, and precision treatment methods to ensure clean, protected spaces.
              </p>
          ...
          <div className="grid gap-10 lg:gap-12 xl:grid-cols-2 items-start">
            ...
            <div>
              ...
              <p className="mt-4 sm:mt-5 max-w-lg text-lg leading-relaxed text-gray-600">
                Don&apos;t let pests compromise your family&apos;s health or business reputation. Book a professional inspection with our certified Patna pest control experts today.
              </p>
      ...
      >
        ...
        <div className="mx-auto max-w-[720px] text-center">
          ...
          >
            ...
            <br />
            <span className="text-[#f4bd00]">in Patna</span>
          </h2>
          ...
          <p
            ...
            "
          >
            From destructive termites to cockroaches, rodents, and bed bugs, explore our specialized pest control services in Patna tailored for homes, apartments, clinics, and commercial spaces.
          </p>
        </div>
      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            A systematic, hassle-free approach designed to solve pest problems quickly and keep Patna properties protected year-round.
          </p>
        </header>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p
                    ...
                    "
                  >
                    We protect Patna homes and commercial facilities with proactive pest management, using safe chemicals that keep your family, pets, and workspace secure.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              >
                <span
                  ...
                  "
                >
                  Need Immediate Assistance in Patna?
                </span>
