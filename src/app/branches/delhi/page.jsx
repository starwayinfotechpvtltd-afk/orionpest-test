...
export const metadata = {
  title: "Pest Control Company in Delhi | 27+ Years of Trusted Pest Services - Orion Pest",
  description:
    "Looking for the top pest control company in Delhi? Orion Pest Solutions provides safe, odorless pest control services, termite control, cockroach removal & rodent defense across Delhi. 27+ years of trust. Book a free inspection today!",
};
...
const services = [
  {
    ...
    description: "Specialized cockroach control in Delhi using odorless gel baits and targeted sprays for modular kitchens and pantries.",
  ...
  },
  {
    ...
    description: "Advanced pre & post-construction termite control in Delhi to safeguard furniture, flooring, and woodwork.",
...
const protectionFeatures = [
  ...
  },
  {
    ...
    description:
      "Our technicians in Delhi are certified, background-verified, and trained in modern pest management.",
    icon: UserCheck,
  },
  {
...
const faq = [
  {
    id: "01",
    question: "Why should I choose Orion Pest Solutions in Delhi?",
    answer:
      "Orion Pest Solutions is an established pest control company in Delhi with over two decades of industry experience. We offer government-approved, low-toxicity treatments, certified local technicians, and guaranteed results tailored to Delhi's climate conditions.",
  },
  {
    id: "02",
    question: "How does your cockroach control in Delhi work?",
    answer:
  ...
  {
    id: "03",
    question: "When is the right time to get termite control in Delhi?",
    answer:
      "Subterranean termites are active throughout the year in Delhi. If you notice mud tubes along walls, hollow-sounding wooden doors, or fine wood dust, you should book a termite inspection immediately.",
  },
  {
    id: "04",
  ...
  {
    id: "06",
    question: "Which areas in Delhi do you serve?",
    answer:
      "We serve all major localities across Delhi NCR, including South Delhi (Hauz Khas, Greater Kailash, Saket), Dwarka, Rohini, Connaught Place, Janakpuri, Vasant Kunj, Noida, and Gurgaon.",
  },
];
            ...
            <div className="w-full space-y-8">
              ...
              <div className="space-y-2">
                <h1 className="text-[34px] sm:text-5xl w-full md:w-2xl xl:text-7xl font-bold text-[#36388D] leading-tight lg:!leading-[4.8rem]">
                  ...
                  <span className="text-[#1095D9]"> Delhi </span>
                </h1>
                <div className="h-[2px] w-28 bg-amber-300"></div>
              </div>

              <p className="text-lg sm:text-xl text-gray-700 font-medium leading-relaxed">
                Looking for a trusted pest control company in Delhi? Orion Pest Solutions provides safe, fast, and eco-friendly pest control services across Delhi NCR. From South Delhi homes and Dwarka apartments to corporate hubs in Connaught Place and Gurgaon, we ensure complete protection against unwanted pests.
              </p>
        ...
        <div className="w-full bg-[#FDC82A] p-10 flex flex-col justify-center items-center space-y-10">
          <div className="w-[400px] md:w-[500px] h-[400px] xl:w-[600px] xl:h-[500px] relative">
            <Image
              ...
              alt="Pest control company in Delhi"
              fill
        ...
        <div className="w-full space-y-5 py-12 md:py-20 px-6 sm:px-10 md:px-16 lg:px-20">
          ...
          <div className="space-y-3">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-[#0D2391] font-bold leading-tight">
              ...
              <span className="text-[#FECE18]">in Delhi</span>
            </h2>
          </div>
          <div className="bg-[#0D2391] h-[5px] w-28 rounded"></div>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Delhi's dense urban layout, seasonal weather extremes—from sweltering summer heat to heavy monsoon moisture—and crowded market corridors create prime breeding environments for pests. Cockroaches frequently invade residential modular kitchens and food establishments, while subterranean termites cause silent, expensive structural damage to wooden interiors, flooring, and door frames.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            As a leading pest control company in Delhi, Orion Pest Solutions brings over 27 years of field experience to your doorstep. We don't rely on temporary sprays; our certified technicians locate root nesting colonies, apply odorless, government-approved formulations, and seal entry points so pests don't return. Whether you need reliable cockroach control in Delhi or specialized termite control in Delhi, our local team ensures clean, long-lasting results.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Our full-spectrum pest control services in Delhi protect homes, high-rise apartments, restaurants, corporate offices, and warehouses across Delhi NCR with transparent pricing and service warranties.
          </p>
          <Link
            href={"/about"}
          ...
          <div className="grid overflow-hidden rounded-[28px] lg:grid-cols-[1fr_1fr]">
            ...
            <div className="relative z-10 bg-white py-8 pr-0 sm:py-10 lg:py-12 lg:pr-10 xl:py-14">
              ...
              <p className="max-w-2xl leading-[1.65] text-gray-700">
                Orion Pest Solutions is an established pest control company in Delhi dedicated to keeping homes, housing societies, corporate offices, and commercial facilities pest-free. Our certified technicians combine scientific pest management, eco-friendly formulations, and precision treatment methods to ensure clean, healthy, and protected environments.
              </p>
                ...
                <div className="relative mt-5 flex-1">
                  ...
                  <div className="absolute left-1/2 top-3 h-[390px] w-[90%] md:w-[78%] -translate-x-1/2 overflow-hidden sm:h-[450px] sm:w-[82%] lg:h-[440px] xl:h-[480px]">
                    <Image
                      ...
                      alt="Pest control services in Delhi"
                      fill
                      priority
          ...
          <div className="grid gap-10 lg:gap-12 xl:grid-cols-2 items-start">
            ...
            <div>
              ...
              <p className="mt-4 sm:mt-5 max-w-lg text-lg leading-relaxed text-gray-600">
                Don&apos;t let pests compromise your family&apos;s health or business reputation. Book a professional inspection with our certified Delhi pest control experts today.
              </p>
      ...
      >
        ...
        <div className="mx-auto max-w-[720px] text-center">
          ...
          >
            ...
            <br />
            <span className="text-[#f4bd00]">in Delhi</span>
          </h2>
          ...
          <p
            ...
            "
          >
            From stubborn termites to pesky cockroaches, rodents, and bed bugs, explore our specialized pest control services in Delhi designed for apartments, independent houses, restaurants, and corporate facilities.
          </p>
        </div>
      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            A systematic, hassle-free approach designed to solve pest problems quickly and keep Delhi properties protected year-round.
          </p>
        </header>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p
                    ...
                    "
                  >
                    We protect Delhi homes and commercial facilities with proactive pest management, using safe chemicals that keep your family, pets, and workspace secure.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              >
                <span
                  ...
                  "
                >
                  Need Immediate Assistance in Delhi?
                </span>
