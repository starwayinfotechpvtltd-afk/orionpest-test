...
export const metadata = {
  title: "Pest Control Company in Bhutan | 27+ Years of Trusted Pest Services - Orion Pest",
  description:
    "Looking for the top pest control company in Bhutan? Orion Pest Solutions provides safe, odorless pest control services, termite control, cockroach removal & rodent defense across Bhutan. 27+ years of trust. Book a free inspection today!",
};
...
const services = [
  {
    ...
    description: "Specialized cockroach control in Bhutan using odorless gel baits and targeted applications for kitchens and resorts.",
  ...
  },
  {
    ...
    description: "Advanced pre & post-construction termite control in Bhutan safeguarding timber structures, wooden floors, and heritage woodwork.",
...
const protectionFeatures = [
  ...
  },
  {
    ...
    description:
      "Our technicians in Bhutan are certified, background-verified, and trained in modern pest management.",
    icon: UserCheck,
  },
  {
...
const faq = [
  {
    id: "01",
    question: "Why should I choose Orion Pest Solutions in Bhutan?",
    answer:
      "Orion Pest Solutions is an established pest control company in Bhutan with over two decades of industry experience. We offer government-approved, low-toxicity treatments, certified local technicians, and guaranteed results tailored to Bhutan's climate conditions.",
  },
  {
    id: "02",
    question: "How does your cockroach control in Bhutan work?",
    answer:
  ...
  {
    id: "03",
    question: "When is the right time to get termite control in Bhutan?",
    answer:
      "Subterranean termites are active throughout the year in Bhutan. If you notice mud tubes along walls, hollow-sounding wooden doors, or fine wood dust, you should book a termite inspection immediately.",
  },
  {
    id: "04",
  ...
  {
    id: "06",
    question: "Which areas in Bhutan do you serve?",
    answer:
      "We provide pest management services across key regions in Bhutan, including Thimphu, Paro, Phuentsholing, Punakha, Wangdue Phodrang, and Gelephu.",
  },
];
            ...
            <div className="w-full space-y-8">
              ...
              <div className="space-y-2">
                <h1 className="text-[34px] sm:text-5xl w-full md:w-2xl xl:text-7xl font-bold text-[#36388D] leading-tight lg:!leading-[4.8rem]">
                  ...
                  <span className="text-[#1095D9]"> Bhutan </span>
                </h1>
                <div className="h-[2px] w-28 bg-amber-300"></div>
              </div>

              <p className="text-lg sm:text-xl text-gray-700 font-medium leading-relaxed">
                Preserve the purity, comfort, and structure of your space with Bhutan's trusted pest management team. Orion Pest Solutions is a leading pest control company in Bhutan providing safe, certified, and eco-friendly pest control services for traditional homes, luxury resorts, hotels, and businesses.
              </p>
        ...
        <div className="w-full bg-[#FDC82A] p-10 flex flex-col justify-center items-center space-y-10">
          <div className="w-[400px] md:w-[500px] h-[400px] xl:w-[600px] xl:h-[500px] relative">
            <Image
              ...
              alt="Pest control company in Bhutan"
              fill
        ...
        <div className="w-full space-y-5 py-12 md:py-20 px-6 sm:px-10 md:px-16 lg:px-20">
          ...
          <div className="space-y-3">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-[#0D2391] font-bold leading-tight">
              ...
              <span className="text-[#FECE18]">in Bhutan</span>
            </h2>
          </div>
          <div className="bg-[#0D2391] h-[5px] w-28 rounded"></div>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Bhutan's rich heritage architecture, extensive use of timber, and diverse geographical elevations—from the temperate valleys of Thimphu and Paro to the subtropical southern border areas like Phuentsholing and Gelephu—present unique pest control needs. Traditional wooden structures and interior woodwork are particularly vulnerable to destructive subterranean termites and wood-boring pests, while hotels, resorts, and residential kitchens require proactive management against cockroaches and rodents.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            As a leading pest control company in Bhutan, Orion Pest Solutions combines over 27 years of proven expertise with environmentally conscious pest management. In harmony with Bhutan's focus on environmental conservation, we prioritize low-toxicity, odorless, and eco-friendly formulations that eliminate pests at their source without harming your surroundings. Whether you require specialized termite control in Bhutan to protect wooden architecture or discreet cockroach control in Bhutan for hospitality and dining venues, our team ensures reliable, long-lasting protection.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Our customized pest control services in Bhutan cater to private residences, heritage properties, luxury resorts, educational institutions, and commercial offices with transparent pricing and full service warranties.
          </p>
          <Link
            href={"/about"}
          ...
          <div className="grid overflow-hidden rounded-[28px] lg:grid-cols-[1fr_1fr]">
            ...
            <div className="relative z-10 bg-white py-8 pr-0 sm:py-10 lg:py-12 lg:pr-10 xl:py-14">
              ...
              <p className="max-w-2xl leading-[1.65] text-gray-700">
                Orion Pest Solutions is an established pest control company in Bhutan committed to maintaining clean, pest-free environments for homes, hotels, and corporate properties. Our trained specialists use modern pest detection techniques and eco-friendly methods to deliver safe, effective protection.
              </p>
                ...
                <div className="relative mt-5 flex-1">
                  ...
                  <div className="absolute left-1/2 top-3 h-[390px] w-[90%] md:w-[78%] -translate-x-1/2 overflow-hidden sm:h-[450px] sm:w-[82%] lg:h-[440px] xl:h-[480px]">
                    <Image
                      ...
                      alt="Pest control services in Bhutan"
                      fill
                      priority
          ...
          <div className="grid gap-10 lg:gap-12 xl:grid-cols-2 items-start">
            ...
            <div>
              ...
              <p className="mt-4 sm:mt-5 max-w-lg text-lg leading-relaxed text-gray-600">
                Don&apos;t let pests compromise your family&apos;s health or business reputation. Book a professional inspection with our certified Bhutan pest control experts today.
              </p>
      ...
      >
        ...
        <div className="mx-auto max-w-[720px] text-center">
          ...
          >
            ...
            <br />
            <span className="text-[#f4bd00]">in Bhutan</span>
          </h2>
          ...
          <p
            ...
            "
          >
            From timber-damaging termites to cockroaches and rodents, explore our eco-conscious pest control services in Bhutan designed for homes, luxury resorts, and commercial properties.
          </p>
        </div>
      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            A systematic, hassle-free approach designed to solve pest problems quickly and keep Bhutan properties protected year-round.
          </p>
        </header>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p
                    ...
                    "
                  >
                    We protect Bhutan homes and commercial facilities with proactive pest management, using safe chemicals that keep your family, pets, and workspace secure.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              >
                <span
                  ...
                  "
                >
                  Need Immediate Assistance in Bhutan?
                </span>
