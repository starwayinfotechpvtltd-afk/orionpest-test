...
export const metadata = {
  title: "Pest Control Company in Chennai | 27+ Years of Trusted Pest Services - Orion Pest",
  description:
    "Looking for the top pest control company in Chennai? Orion Pest Solutions provides safe, odorless pest control services, termite control, cockroach removal & rodent defense across Chennai. 27+ years of trust. Book a free inspection today!",
};
...
const services = [
  {
    ...
    description: "Specialized cockroach control in Chennai using odorless gel baits and targeted sprays for modular kitchens and commercial food areas.",
  ...
  },
  {
    ...
    description: "Advanced pre & post-construction termite control in Chennai safeguarding wooden interiors, door frames, and flooring.",
...
const protectionFeatures = [
  ...
  },
  {
    ...
    description:
      "Our technicians in Chennai are certified, background-verified, and trained in modern pest management.",
    icon: UserCheck,
  },
  {
...
const faq = [
  {
    id: "01",
    question: "Why should I choose Orion Pest Solutions in Chennai?",
    answer:
      "Orion Pest Solutions is an established pest control company in Chennai with over two decades of industry experience. We offer government-approved, low-toxicity treatments, certified local technicians, and guaranteed results tailored to Chennai's climate conditions.",
  },
  {
    id: "02",
    question: "How does your cockroach control in Chennai work?",
    answer:
  ...
  {
    id: "03",
    question: "When is the right time to get termite control in Chennai?",
    answer:
      "Subterranean termites are active throughout the year in Chennai. If you notice mud tubes along walls, hollow-sounding wooden doors, or fine wood dust, you should book a termite inspection immediately.",
  },
  {
    id: "04",
  ...
  },
  {
    ...
    answer:
      "We serve all major localities across Chennai, including Anna Nagar, T. Nagar, Adyar, Velachery, OMR, ECR, Porur, Guindy, Nungambakkam, Tambaram, and Mylapore.",
  },
];
            ...
            <div className="w-full space-y-8">
              ...
              <div className="space-y-2">
                <h1 className="text-[34px] sm:text-5xl w-full md:w-2xl xl:text-7xl font-bold text-[#36388D] leading-tight lg:!leading-[4.8rem]">
                  ...
                  <span className="text-[#1095D9]"> Chennai </span>
                </h1>
                <div className="h-[2px] w-28 bg-amber-300"></div>
              </div>

              <p className="text-lg sm:text-xl text-gray-700 font-medium leading-relaxed">
                Looking for a trusted pest control company in Chennai? Orion Pest Solutions offers safe, fast, and eco-friendly pest control services across Chennai. From coastal residences in ECR and Adyar to IT corridors on OMR and commercial hubs in T. Nagar, we keep your properties pest-free.
              </p>
      ...
      <section className="w-full grid grid-cols-1 lg:grid-cols-2">
        <div className="w-full bg-[#FDC82A] p-10 flex flex-col justify-center items-center space-y-10">
          <div className="w-[400px] md:w-[500px] h-[400px] xl:w-[600px] xl:h-[500px] relative">
            <Image
              ...
              alt="Pest control company in Chennai"
              fill
        ...
        <div className="w-full space-y-5 py-12 md:py-20 px-6 sm:px-10 md:px-16 lg:px-20">
          ...
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Chennai's tropical maritime climate, warm temperatures, and coastal humidity create fertile conditions for pest breeding throughout the year. Cockroaches spread rapidly in residential kitchens and restaurants, mosquitoes thrive in coastal breeze areas, and termites cause quiet, catastrophic damage to wooden door frames, wardrobes, and structural timber.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            As a leading pest control company in Chennai, Orion Pest Solutions provides modern, odorless treatments with over 27 years of expertise. We apply low-toxicity, government-approved formulations directly to root nesting grounds, ensuring pests are eliminated without disrupting your family or business. Whether you need immediate cockroach control in Chennai or comprehensive termite control in Chennai, our certified technicians deliver guaranteed satisfaction.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Our full range of pest control services in Chennai protects villas, high-rise apartments, IT campuses, hospitals, and cloud kitchens with upfront pricing and scheduled follow-up support.
          </p>
          <Link
            href={"/about"}
          ...
          <div className="grid overflow-hidden rounded-[28px] lg:grid-cols-[1fr_1fr]">
            ...
            <div className="relative z-10 bg-white py-8 pr-0 sm:py-10 lg:py-12 lg:pr-10 xl:py-14">
              ...
              <p className="max-w-2xl leading-[1.65] text-gray-700">
                Orion Pest Solutions is an established pest control company in Chennai dedicated to keeping homes, housing societies, corporate offices, and commercial establishments pest-free. Our certified technicians combine scientific pest management, eco-friendly formulations, and precision treatment methods to ensure clean, healthy, and protected environments.
              </p>
                ...
                <div className="relative mt-5 flex-1">
                  ...
                  <div className="absolute left-1/2 top-3 h-[390px] w-[90%] md:w-[78%] -translate-x-1/2 overflow-hidden sm:h-[450px] sm:w-[82%] lg:h-[440px] xl:h-[480px]">
                    <Image
                      ...
                      alt="Pest control services in Chennai"
                      fill
                      priority
          ...
          <div className="grid gap-10 lg:gap-12 xl:grid-cols-2 items-start">
            ...
            <div>
              ...
              <p className="mt-4 sm:mt-5 max-w-lg text-lg leading-relaxed text-gray-600">
                Don&apos;t let pests compromise your family&apos;s health or business reputation. Book a professional inspection with our certified Chennai pest control experts today.
              </p>
      ...
      >
        ...
        <div className="mx-auto max-w-[720px] text-center">
          ...
          >
            ...
            <br />
            <span className="text-[#f4bd00]">in Chennai</span>
          </h2>
          ...
          <p
            ...
            "
          >
            From destructive termites to pesky cockroaches, mosquitoes, and rodents, explore our specialized pest control services in Chennai designed for apartments, coastal villas, tech parks, and commercial spaces.
          </p>
        </div>
      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            A systematic, hassle-free approach designed to solve pest problems quickly and keep Chennai properties protected year-round.
          </p>
        </header>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p
                    ...
                    "
                  >
                    We protect Chennai homes and commercial facilities with proactive pest management, using safe chemicals that keep your family, pets, and workspace secure.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              >
                <span
                  ...
                  "
                >
                  Need Immediate Assistance in Chennai?
                </span>
