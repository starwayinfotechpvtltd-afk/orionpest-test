...
export const metadata = {
  title: "Pest Control Company in Visakhapatnam | 27+ Years of Trusted Pest Services - Orion Pest",
  description:
    "Looking for the top pest control company in Visakhapatnam? Orion Pest Solutions provides safe, odorless pest control services, termite control, cockroach removal & rodent defense across Visakhapatnam. 27+ years of trust. Book a free inspection today!",
};
...
const stats = [
  ...
  },
  {
    ...
    subHeading: "Across Vizag & Steel City",
  },
];
...
const stats3 = [
  ...
  {
    icon: <UsersRound />,
    heading: "Visakhapatnam Operations",
...
const services = [
  {
    ...
    description: "Specialized cockroach control in Visakhapatnam using odorless gel baits and targeted sprays for modular kitchens and commercial pantries.",
  ...
  },
  {
    ...
    description: "Advanced pre & post-construction termite control in Visakhapatnam safeguarding wooden interiors, door frames, and flooring.",
...
const protectionFeatures = [
  ...
  },
  {
    ...
    description:
      "Our technicians in Visakhapatnam are certified, background-verified, and trained in modern pest management.",
    icon: UserCheck,
  },
  {
...
const faq = [
  {
    id: "01",
    question: "Why should I choose Orion Pest Solutions in Visakhapatnam?",
    answer:
      "Orion Pest Solutions is an established pest control company in Visakhapatnam with over two decades of industry experience. We offer government-approved, low-toxicity treatments, certified local technicians, and guaranteed results tailored to Visakhapatnam's climate conditions.",
  },
  {
    id: "02",
    question: "How does your cockroach control in Visakhapatnam work?",
    answer:
  ...
  {
    id: "03",
    question: "When is the right time to get termite control in Visakhapatnam?",
    answer:
      "Subterranean termites are active throughout the year in Visakhapatnam. If you notice mud tubes along walls, hollow-sounding wooden doors, or fine wood dust, you should book a termite inspection immediately.",
  },
  {
    id: "04",
  ...
  {
    id: "06",
    question: "Which areas in Visakhapatnam do you serve?",
    answer:
      "We serve all residential and commercial zones across Visakhapatnam, including MVP Colony, Madhurawada, Gajuwaka, Seethammadhara, Siripuram, Beach Road, Dwaraka Nagar, and Pendurthi.",
  },
];
            ...
            <div className="w-full space-y-8">
              ...
              <div className="space-y-2">
                <h1 className="text-[34px] sm:text-5xl w-full md:w-2xl xl:text-7xl font-bold text-[#36388D] leading-tight lg:!leading-[4.8rem]">
                  ...
                  <span className="text-[#1095D9]"> Visakhapatnam </span>
                </h1>
                <div className="h-[2px] w-28 bg-amber-300"></div>
              </div>

              <p className="text-lg sm:text-xl text-gray-700 font-medium leading-relaxed">
                Looking for a trusted pest control company in Visakhapatnam? Orion Pest Solutions offers safe, fast, and eco-friendly pest control services across Vizag. From coastal apartments in MVP Colony and Beach Road to industrial hubs in Gajuwaka and Madhurawada, we keep your property pest-free.
              </p>
        ...
        <div className="w-full bg-[#FDC82A] p-10 flex flex-col justify-center items-center space-y-10">
          <div className="w-[400px] md:w-[500px] h-[400px] xl:w-[600px] xl:h-[500px] relative">
            <Image
              ...
              alt="Pest control company in Visakhapatnam"
              fill
        ...
        <div className="w-full space-y-5 py-12 md:py-20 px-6 sm:px-10 md:px-16 lg:px-20">
          ...
          <div className="space-y-3">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-[#0D2391] font-bold leading-tight">
              ...
              <span className="text-[#FECE18]">in Visakhapatnam</span>
            </h2>
          </div>
          <div className="bg-[#0D2391] h-[5px] w-28 rounded"></div>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Visakhapatnam's coastal humidity, maritime atmosphere, and thriving industrial and port corridors create severe pest pressures. Subterranean termites frequently compromise wooden doors, cabinetry, and structural timber, while cockroaches, rodents, and bed bugs multiply quickly in residential colonies and commercial establishments.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            As an established pest control company in Visakhapatnam, Orion Pest Solutions delivers scientifically proven, odorless treatments with over 27 years of industry excellence. We target root breeding colonies and establish moisture-resistant barriers that withstand coastal weather conditions. Whether you need reliable cockroach control in Visakhapatnam or specialized termite control in Visakhapatnam, our certified team ensures guaranteed protection.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Our full-spectrum pest control services in Visakhapatnam protect independent houses, high-rise apartments, port warehouses, healthcare facilities, and hotels with transparent pricing and full service warranties.
          </p>
          <Link
            href={"/about"}
          ...
          <div className="grid overflow-hidden rounded-[28px] lg:grid-cols-[1fr_1fr]">
            ...
            <div className="relative z-10 bg-white py-8 pr-0 sm:py-10 lg:py-12 lg:pr-10 xl:py-14">
              ...
              <p className="max-w-2xl leading-[1.65] text-gray-700">
                Orion Pest Solutions is an established pest control company in Visakhapatnam dedicated to keeping residential communities, corporate offices, and industrial premises pest-free. Our certified technicians combine scientific pest management, eco-friendly formulations, and precision treatment methods to ensure clean, healthy environments.
              </p>
                ...
                <div className="relative mt-5 flex-1">
                  ...
                  <div className="absolute left-1/2 top-3 h-[390px] w-[90%] md:w-[78%] -translate-x-1/2 overflow-hidden sm:h-[450px] sm:w-[82%] lg:h-[440px] xl:h-[480px]">
                    <Image
                      ...
                      alt="Pest control services in Visakhapatnam"
                      fill
                      priority
          ...
          <div className="grid gap-10 lg:gap-12 xl:grid-cols-2 items-start">
            ...
            <div>
              ...
              <p className="mt-4 sm:mt-5 max-w-lg text-lg leading-relaxed text-gray-600">
                Don&apos;t let pests compromise your family&apos;s health or business reputation. Book a professional inspection with our certified Visakhapatnam pest control experts today.
              </p>
      ...
      >
        ...
        <div className="mx-auto max-w-[720px] text-center">
          ...
          >
            ...
            <br />
            <span className="text-[#f4bd00]">in Visakhapatnam</span>
          </h2>
          ...
          <p
            ...
            "
          >
            From persistent termites to cockroaches, bed bugs, and rodents, explore our specialized pest control services in Visakhapatnam tailored for apartments, coastal residences, and industrial plants.
          </p>
        </div>
      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            A systematic, hassle-free approach designed to solve pest problems quickly and keep Visakhapatnam properties protected year-round.
          </p>
        </header>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p
                    ...
                    "
                  >
                    We protect Visakhapatnam homes and commercial facilities with proactive pest management, using safe chemicals that keep your family, pets, and workspace secure.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              >
                <span
                  ...
                  "
                >
                  Need Immediate Assistance in Visakhapatnam?
                </span>
