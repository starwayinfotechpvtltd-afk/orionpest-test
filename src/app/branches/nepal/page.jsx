...
export const metadata = {
  title: "Pest Control Company in Nepal | 27+ Years of Trusted Pest Services - Orion Pest",
  description:
    "Looking for the top pest control company in Nepal? Orion Pest Solutions provides safe, odorless pest control services, termite control, cockroach removal & rodent defense across Nepal. 27+ years of trust. Book a free inspection today!",
};
...
const stats = [
  ...
  },
  {
    ...
    subHeading: "Across Kathmandu Valley & Nepal",
  },
];
...
const services = [
  {
    ...
    description: "Specialized cockroach control in Nepal using odorless gel baits and targeted applications for kitchens, restaurants, and hotels.",
  ...
  },
  {
    ...
    description: "Advanced pre & post-construction termite control in Nepal safeguarding timber structures, wooden beams, and interior woodwork.",
...
const protectionFeatures = [
  ...
  },
  {
    ...
    description:
      "Our technicians in Nepal are certified, background-verified, and trained in modern pest management.",
    icon: UserCheck,
  },
  {
...
const faq = [
  {
    id: "01",
    question: "Why should I choose Orion Pest Solutions in Nepal?",
    answer:
      "Orion Pest Solutions is an established pest control company in Nepal with over two decades of industry experience. We offer government-approved, low-toxicity treatments, certified local technicians, and guaranteed results tailored to Nepal's climate conditions.",
  },
  {
    id: "02",
    question: "How does your cockroach control in Nepal work?",
    answer:
  ...
  {
    id: "03",
    question: "When is the right time to get termite control in Nepal?",
    answer:
      "Subterranean termites are active throughout the year in Nepal. If you notice mud tubes along walls, hollow-sounding wooden doors, or fine wood dust, you should book a termite inspection immediately.",
  },
  {
    id: "04",
  ...
  {
    id: "06",
    question: "Which areas in Nepal do you serve?",
    answer:
      "We provide comprehensive pest management services across key regions in Nepal, including Kathmandu (Thamel, Lazimpat, Baneshwor), Lalitpur/Patan, Bhaktapur, Pokhara, and Biratnagar.",
  },
];
            ...
            <div className="w-full space-y-8">
              ...
              <div className="space-y-2">
                <h1 className="text-[34px] sm:text-5xl w-full md:w-2xl xl:text-7xl font-bold text-[#36388D] leading-tight lg:!leading-[4.8rem]">
                  ...
                  <span className="text-[#1095D9]"> Nepal </span>
                </h1>
                <div className="h-[2px] w-28 bg-amber-300"></div>
              </div>

              <p className="text-lg sm:text-xl text-gray-700 font-medium leading-relaxed">
                Looking for a trusted pest control company in Nepal? Orion Pest Solutions provides safe, fast, and eco-friendly pest control services across the Kathmandu Valley and major cities in Nepal. From heritage homes and luxury hotels in Kathmandu and Pokhara to commercial premises, we keep your property pest-free.
              </p>
        ...
        <div className="w-full bg-[#FDC82A] p-10 flex flex-col justify-center items-center space-y-10">
          <div className="w-[400px] md:w-[500px] h-[400px] xl:w-[600px] xl:h-[500px] relative">
            <Image
              ...
              alt="Pest control company in Nepal"
              fill
        ...
        <div className="w-full space-y-5 py-12 md:py-20 px-6 sm:px-10 md:px-16 lg:px-20">
          ...
          <div className="space-y-3">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-[#0D2391] font-bold leading-tight">
              ...
              <span className="text-[#FECE18]">in Nepal</span>
            </h2>
          </div>
          <div className="bg-[#0D2391] h-[5px] w-28 rounded"></div>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Nepal's diverse elevations, traditional timber architecture, and booming hospitality industry create unique pest vulnerabilities. Subterranean termites and wood borers silently compromise wooden beams, carved windows, and furniture in heritage properties and modern buildings, while cockroaches, bed bugs, and rodents frequently trouble hotels, restaurants, and residential kitchens.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            As a leading pest control company in Nepal, Orion Pest Solutions provides specialized, eco-conscious pest management with over 27 years of industry excellence. We use low-toxicity, odorless, and government-approved formulations that eliminate pest colonies at their roots without harming your surroundings or family. Whether you require specialized termite control in Nepal to protect wooden architecture or discreet cockroach control in Nepal for hospitality venues, our team ensures dependable protection.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Our comprehensive pest control services in Nepal protect private residences, boutique hotels, embassies, restaurants, and commercial offices with transparent pricing and full service warranties.
          </p>
          <Link
            href={"/about"}
          ...
          <div className="grid overflow-hidden rounded-[28px] lg:grid-cols-[1fr_1fr]">
            ...
            <div className="relative z-10 bg-white py-8 pr-0 sm:py-10 lg:py-12 lg:pr-10 xl:py-14">
              ...
              <p className="max-w-2xl leading-[1.65] text-gray-700">
                Orion Pest Solutions is an established pest control company in Nepal dedicated to keeping heritage properties, hotels, and homes pest-free. Our certified specialists apply modern pest detection techniques and eco-friendly methods to deliver safe, effective protection.
              </p>
                ...
                <div className="relative mt-5 flex-1">
                  ...
                  <div className="absolute left-1/2 top-3 h-[390px] w-[90%] md:w-[78%] -translate-x-1/2 overflow-hidden sm:h-[450px] sm:w-[82%] lg:h-[440px] xl:h-[480px]">
                    <Image
                      ...
                      alt="Pest control services in Nepal"
                      fill
                      priority
          ...
          <div className="grid gap-10 lg:gap-12 xl:grid-cols-2 items-start">
            ...
            <div>
              ...
              <p className="mt-4 sm:mt-5 max-w-lg text-lg leading-relaxed text-gray-600">
                Don&apos;t let pests compromise your family&apos;s health or business reputation. Book a professional inspection with our certified Nepal pest control experts today.
              </p>
      ...
      >
        ...
        <div className="mx-auto max-w-[720px] text-center">
          ...
          >
            ...
            <br />
            <span className="text-[#f4bd00]">in Nepal</span>
          </h2>
          ...
          <p
            ...
            "
          >
            From timber-damaging termites to bed bugs, cockroaches, and rodents, explore our professional pest control services in Nepal tailored for homes, hotels, and commercial establishments.
          </p>
        </div>
      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            A systematic, hassle-free approach designed to solve pest problems quickly and keep Nepal properties protected year-round.
          </p>
        </header>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p
                    ...
                    "
                  >
                    We protect Nepal homes and commercial facilities with proactive pest management, using safe chemicals that keep your family, pets, and workspace secure.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              >
                <span
                  ...
                  "
                >
                  Need Immediate Assistance in Nepal?
                </span>
