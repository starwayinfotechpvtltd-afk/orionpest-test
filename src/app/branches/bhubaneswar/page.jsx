...
export const metadata = {
  title: "Pest Control Company in Bhubaneswar | 27+ Years of Trusted Pest Services - Orion Pest",
  description:
    "Looking for the top pest control company in Bhubaneswar? Orion Pest Solutions provides safe, odorless pest control services, termite control, cockroach removal & rodent defense across Bhubaneswar. 27+ years of trust. Book a free inspection today!",
};
...
const stats = [
  ...
  },
  {
    ...
    subHeading: "Across Bhubaneswar & Cuttack",
  },
];
...
const services = [
  {
    ...
    description: "Specialized cockroach control in Bhubaneswar with odorless gel baits and targeted sprays for kitchens and commercial pantries.",
  ...
  },
  {
    ...
    description: "Advanced pre & post-construction termite control in Bhubaneswar to safeguard woodwork and foundations.",
...
const protectionFeatures = [
  ...
  },
  {
    ...
    description:
      "Our technicians in Bhubaneswar are certified, background-verified, and trained in modern pest management.",
    icon: UserCheck,
  },
  {
...
const faq = [
  {
    id: "01",
    question: "Why should I choose Orion Pest Solutions in Bhubaneswar?",
    answer:
      "Orion Pest Solutions is an established pest control company in Bhubaneswar with over two decades of industry experience. We offer government-approved, low-toxicity treatments, certified local technicians, and guaranteed results tailored to Bhubaneswar's climate conditions.",
  },
  {
    id: "02",
    question: "How does your cockroach control in Bhubaneswar work?",
    answer:
  ...
  {
    id: "03",
    question: "When is the right time to get termite control in Bhubaneswar?",
    answer:
      "Subterranean termites are active throughout the year in Bhubaneswar. If you notice mud tubes along walls, hollow-sounding wooden doors, or fine wood dust, you should book a termite inspection immediately.",
  },
  {
    id: "04",
  ...
  {
    id: "06",
    question: "Which areas in Bhubaneswar do you serve?",
    answer:
      "We serve all residential and commercial zones across Bhubaneswar and Cuttack, including Patia, Nayapalli, Saheed Nagar, Chandrasekharpur, Khandagiri, Jayadev Vihar, Rasulgarh, KIIT area, and Infocity.",
  },
];
            ...
            <div className="w-full space-y-8">
              ...
              <div className="space-y-2">
                <h1 className="text-[34px] sm:text-5xl w-full md:w-2xl xl:text-7xl font-bold text-[#36388D] leading-tight lg:!leading-[4.8rem]">
                  ...
                  <span className="text-[#1095D9]"> Bhubaneswar </span>
                </h1>
                <div className="h-[2px] w-28 bg-amber-300"></div>
              </div>

              <p className="text-lg sm:text-xl text-gray-700 font-medium leading-relaxed">
                Looking for a trusted pest control company in Bhubaneswar? Orion Pest Solutions offers safe, fast, and eco-friendly pest control services across Bhubaneswar. From homes and apartments to corporate offices and educational campuses, we ensure complete protection against unwanted pests.
              </p>
        ...
        <div className="w-full bg-[#FDC82A] p-10 flex flex-col justify-center items-center space-y-10">
          <div className="w-[400px] md:w-[500px] h-[400px] xl:w-[600px] xl:h-[500px] relative">
            <Image
              ...
              alt="Pest control company in Bhubaneswar"
              fill
        ...
        <div className="w-full space-y-5 py-12 md:py-20 px-6 sm:px-10 md:px-16 lg:px-20">
          ...
          <div className="space-y-3">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-[#0D2391] font-bold leading-tight">
              ...
              <span className="text-[#FECE18]">in Bhubaneswar</span>
            </h2>
          </div>
          <div className="bg-[#0D2391] h-[5px] w-28 rounded"></div>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Bhubaneswar's coastal humidity, heavy monsoon seasons, and rapid urban growth create an environment where pests can quickly become a persistent nuisance. Subterranean termites pose a continuous threat to wooden doors, cabinets, and structural fittings, while cockroaches and rodents often infiltrate kitchens, pantries, and commercial establishments in busy hubs like Patia, Saheed Nagar, and Nayapalli.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            As a trusted pest control company in Bhubaneswar, Orion Pest Solutions provides proven, science-based treatments with over 27 years of industry excellence. We do not just apply temporary sprays; our certified technicians locate the root colonies, apply government-approved, low-toxicity formulations, and seal entry points so pests don't return. Whether you require prompt cockroach control in Bhubaneswar or comprehensive termite control in Bhubaneswar, our local team ensures clean, long-lasting results.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Our specialized pest control services in Bhubaneswar cater to residences, apartments, commercial offices, hospitals, and educational institutions with transparent pricing and complete service warranties.
          </p>
          <Link
            href={"/about"}
          ...
          <div className="grid overflow-hidden rounded-[28px] lg:grid-cols-[1fr_1fr]">
            ...
            <div className="relative z-10 bg-white py-8 pr-0 sm:py-10 lg:py-12 lg:pr-10 xl:py-14">
              ...
              <p className="max-w-2xl leading-[1.65] text-gray-700">
                Orion Pest Solutions is an established pest control company in Bhubaneswar dedicated to keeping homes, housing societies, corporate offices, and institutions pest-free. Our certified technicians combine scientific pest management, eco-friendly formulations, and precision treatment methods to ensure clean, healthy, and protected environments for everyone.
              </p>
                ...
                <div className="relative mt-5 flex-1">
                  ...
                  <div className="absolute left-1/2 top-3 h-[390px] w-[90%] md:w-[78%] -translate-x-1/2 overflow-hidden sm:h-[450px] sm:w-[82%] lg:h-[440px] xl:h-[480px]">
                    <Image
                      ...
                      alt="Pest control services in Bhubaneswar"
                      fill
                      priority
          ...
          <div className="grid gap-10 lg:gap-12 xl:grid-cols-2 items-start">
            ...
            <div>
              ...
              <p className="mt-4 sm:mt-5 max-w-lg text-lg leading-relaxed text-gray-600">
                Don&apos;t let pests compromise your family&apos;s health or business reputation. Book a professional inspection with our certified Bhubaneswar pest control experts today.
              </p>
      ...
      >
        ...
        <div className="mx-auto max-w-[720px] text-center">
          ...
          >
            ...
            <br />
            <span className="text-[#f4bd00]">in Bhubaneswar</span>
          </h2>
          ...
          <p
            ...
            "
          >
            From destructive termites to cockroaches and rodents, explore our professional pest control services in Bhubaneswar designed for homes, apartments, clinics, and commercial spaces.
          </p>
        </div>
      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            A systematic, hassle-free approach designed to solve pest problems quickly and keep Bhubaneswar properties protected year-round.
          </p>
        </header>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p
                    ...
                    "
                  >
                    We protect Bhubaneswar homes and commercial facilities with proactive pest management, using safe chemicals that keep your family, pets, and workspace secure.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              >
                <span
                  ...
                  "
                >
                  Need Immediate Assistance in Bhubaneswar?
                </span>
