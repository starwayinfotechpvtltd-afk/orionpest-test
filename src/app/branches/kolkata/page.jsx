...
export const metadata = {
  title: "Pest Control Company in Kolkata | 27+ Years of Trusted Pest Services - Orion Pest",
  description:
    "Looking for the top pest control company in Kolkata? Orion Pest Solutions provides safe, odorless pest control services, termite control, cockroach removal & rodent defense across Kolkata. 27+ years of trust. Book a free inspection today!",
};
...
const stats = [
  ...
  },
  {
    ...
    subHeading: "Across Kolkata & Howrah",
  },
];
...
const stats3 = [
  ...
  {
    icon: <UsersRound />,
    heading: "Kolkata Headquarters & Branch",
...
const services = [
  {
    ...
    description: "Specialized cockroach control in Kolkata with odorless gel baits and targeted sprays for modular kitchens and commercial pantries.",
  ...
  },
  {
    ...
    description: "Advanced pre & post-construction termite control in Kolkata to safeguard furniture, flooring, and heritage woodwork.",
...
const protectionFeatures = [
  ...
  },
  {
    ...
    description:
      "Our technicians in Kolkata are certified, background-verified, and trained in modern pest management.",
    icon: UserCheck,
  },
  {
...
const faq = [
  {
    id: "01",
    question: "Why should I choose Orion Pest Solutions in Kolkata?",
    answer:
      "Orion Pest Solutions is an established pest control company in Kolkata with over two decades of industry experience. We offer government-approved, low-toxicity treatments, certified local technicians, and guaranteed results tailored to Kolkata's climate conditions.",
  },
  {
    id: "02",
    question: "How does your cockroach control in Kolkata work?",
    answer:
  ...
  {
    id: "03",
    question: "When is the right time to get termite control in Kolkata?",
    answer:
      "Subterranean termites are active throughout the year in Kolkata. If you notice mud tubes along walls, hollow-sounding wooden doors, or fine wood dust, you should book a termite inspection immediately.",
  },
  {
    id: "04",
  ...
  },
  {
    ...
    answer:
      "We serve all residential and commercial zones across Kolkata, including Salt Lake, New Town, Tollygunge, Ballygunge, Behala, Alipore, Dum Dum, Garia, Howrah, and Rajarhat.",
  },
];
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-12 lg:gap-8 items-center justify-between">
            ...
            <div className="w-full space-y-8">
              ...
              <p className="text-lg sm:text-xl text-gray-700 font-medium leading-relaxed">
                Looking for a trusted pest control company in Kolkata? Orion Pest Solutions offers safe, fast, and eco-friendly pest control services across Kolkata and Howrah. From heritage homes in North Kolkata to modern high-rises in Salt Lake, New Town, and South Kolkata, we ensure complete protection against unwanted pests.
              </p>
        ...
        <div className="w-full bg-[#FDC82A] p-10 flex flex-col justify-center items-center space-y-10">
          <div className="w-[400px] md:w-[500px] h-[400px] xl:w-[600px] xl:h-[500px] relative">
            <Image
              ...
              alt="Pest control company in Kolkata"
              fill
        ...
        <div className="w-full space-y-5 py-12 md:py-20 px-6 sm:px-10 md:px-16 lg:px-20">
          ...
          <div className="space-y-3">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-[#0D2391] font-bold leading-tight">
              ...
              <span className="text-[#FECE18]">in Kolkata</span>
            </h2>
          </div>
          <div className="bg-[#0D2391] h-[5px] w-28 rounded"></div>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Kolkata's humid subtropical climate, old drainage systems, and extensive use of timber in traditional and modern homes make pest management an essential year-round priority. Subterranean termites pose severe threats to heritage woodwork, doors, and books, while cockroaches and rodents often infest kitchens, pantries, and commercial hubs.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Headquartered in Kolkata since 1998, Orion Pest Solutions is the city's most trusted pest control company. We don't just spray surface chemicals; our licensed experts locate root nesting colonies, apply odorless, government-approved formulations, and seal entry points so pests don't return. Whether you require reliable cockroach control in Kolkata or specialized termite control in Kolkata, our certified local team ensures clean, long-lasting results.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Our full-spectrum pest control services in Kolkata protect independent houses, residential complexes, restaurants, sweet shops, hospitals, and commercial offices with transparent pricing and dependable warranties.
          </p>
          <Link
            href={"/about"}
          ...
          <div className="grid overflow-hidden rounded-[28px] lg:grid-cols-[1fr_1fr]">
            ...
            <div className="relative z-10 bg-white py-8 pr-0 sm:py-10 lg:py-12 lg:pr-10 xl:py-14">
              ...
              <p className="max-w-2xl leading-[1.65] text-gray-700">
                Orion Pest Solutions is an established pest control company in Kolkata with over 27 years of pioneering leadership in pest management. Our certified technicians combine scientific pest detection, eco-friendly formulations, and precision treatment methods to ensure clean, healthy, and protected environments for everyone.
              </p>
                ...
                <div className="relative mt-5 flex-1">
                  ...
                  <div className="absolute left-1/2 top-3 h-[390px] w-[90%] md:w-[78%] -translate-x-1/2 overflow-hidden sm:h-[450px] sm:w-[82%] lg:h-[440px] xl:h-[480px]">
                    <Image
                      ...
                      alt="Pest control services in Kolkata"
                      fill
                      priority
          ...
          <div className="grid gap-10 lg:gap-12 xl:grid-cols-2 items-start">
            ...
            <div>
              ...
              <p className="mt-4 sm:mt-5 max-w-lg text-lg leading-relaxed text-gray-600">
                Don&apos;t let pests compromise your family&apos;s health or business reputation. Book a professional inspection with our certified Kolkata pest control experts today.
              </p>
      ...
      >
        ...
        <div className="mx-auto max-w-[720px] text-center">
          ...
          >
            ...
            <br />
            <span className="text-[#f4bd00]">in Kolkata</span>
          </h2>
          ...
          <p
            ...
            "
          >
            From stubborn termites to pesky cockroaches and rodents, explore our specialized pest control services in Kolkata designed for homes, apartments, heritage buildings, and commercial facilities.
          </p>
        </div>
      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            A systematic, hassle-free approach designed to solve pest problems quickly and keep Kolkata properties protected year-round.
          </p>
        </header>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p
                    ...
                    "
                  >
                    We protect Kolkata homes and commercial facilities with proactive pest management, using safe chemicals that keep your family, pets, and workspace secure.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              >
                <span
                  ...
                  "
                >
                  Need Immediate Assistance in Kolkata?
                </span>
