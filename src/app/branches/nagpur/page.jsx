...
export const metadata = {
  title: "Pest Control Company in Nagpur | 27+ Years of Trusted Pest Services - Orion Pest",
  description:
    "Looking for the top pest control company in Nagpur? Orion Pest Solutions provides safe, odorless pest control services, termite control, cockroach removal & rodent defense across Nagpur. 27+ years of trust. Book a free inspection today!",
};
...
const stats = [
  ...
  },
  {
    ...
    subHeading: "Across Nagpur & MIHAN",
  },
];
...
const services = [
  {
    ...
    description: "Specialized cockroach control in Nagpur with odorless gel baits and targeted sprays for modular kitchens and commercial pantries.",
  ...
  },
  {
    ...
    description: "Advanced pre & post-construction termite control in Nagpur safeguarding wooden interiors, door frames, and structural timber.",
...
const protectionFeatures = [
  ...
  },
  {
    ...
    description:
      "Our technicians in Nagpur are certified, background-verified, and trained in modern pest management.",
    icon: UserCheck,
  },
  {
...
const faq = [
  {
    id: "01",
    question: "Why should I choose Orion Pest Solutions in Nagpur?",
    answer:
      "Orion Pest Solutions is an established pest control company in Nagpur with over two decades of industry experience. We offer government-approved, low-toxicity treatments, certified local technicians, and guaranteed results tailored to Nagpur's climate conditions.",
  },
  {
    id: "02",
    question: "How does your cockroach control in Nagpur work?",
    answer:
  ...
  {
    id: "03",
    question: "When is the right time to get termite control in Nagpur?",
    answer:
      "Subterranean termites are active throughout the year in Nagpur. If you notice mud tubes along walls, hollow-sounding wooden doors, or fine wood dust, you should book a termite inspection immediately.",
  },
  {
    id: "04",
  ...
  },
  {
    ...
    answer:
      "We serve all major localities across Nagpur, including Dharampeth, Ramdaspeth, Wardha Road, Sitabuldi, Manish Nagar, Pratap Nagar, Trimurti Nagar, Hingna, and MIHAN area.",
  },
];
            ...
            <div className="w-full space-y-8">
              ...
              <div className="space-y-2">
                <h1 className="text-[34px] sm:text-5xl w-full md:w-2xl xl:text-7xl font-bold text-[#36388D] leading-tight lg:!leading-[4.8rem]">
                  ...
                  <span className="text-[#1095D9]"> Nagpur </span>
                </h1>
                <div className="h-[2px] w-28 bg-amber-300"></div>
              </div>

              <p className="text-lg sm:text-xl text-gray-700 font-medium leading-relaxed">
                Looking for a trusted pest control company in Nagpur? Orion Pest Solutions provides safe, fast, and eco-friendly pest control services across Nagpur. From residences in Dharampeth, Ramdaspeth, and Wardha Road to logistics hubs in MIHAN and Hingna MIDC, we keep your property pest-free.
              </p>
        ...
        <div className="w-full bg-[#FDC82A] p-10 flex flex-col justify-center items-center space-y-10">
          <div className="w-[400px] md:w-[500px] h-[400px] xl:w-[600px] xl:h-[500px] relative">
            <Image
              ...
              alt="Pest control company in Nagpur"
              fill
        ...
        <div className="w-full space-y-5 py-12 md:py-20 px-6 sm:px-10 md:px-16 lg:px-20">
          ...
          <div className="space-y-3">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-[#0D2391] font-bold leading-tight">
              ...
              <span className="text-[#FECE18]">in Nagpur</span>
            </h2>
          </div>
          <div className="bg-[#0D2391] h-[5px] w-28 rounded"></div>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Nagpur's central logistics corridors, extreme summer heat, and post-monsoon humidity create prime breeding grounds for termites, cockroaches, and warehouse rodents. Subterranean termites silently hollow out wooden furniture, doors, and structural fittings, while cockroaches and rodents compromise hygiene in homes, healthcare facilities, and cargo warehouses.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            As an established pest control company in Nagpur, Orion Pest Solutions brings over 27 years of proven expertise. We utilize odorless, government-approved formulations and deep colony eradication techniques that tackle pests at their source without causing toxic fumes. Whether you require prompt cockroach control in Nagpur or specialized termite control in Nagpur, our certified local technicians guarantee long-lasting protection.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Our full range of pest control services in Nagpur protects apartments, independent bungalows, logistics hubs, hospitals, and manufacturing units with upfront pricing and service guarantees.
          </p>
          <Link
            href={"/about"}
          ...
          <div className="grid overflow-hidden rounded-[28px] lg:grid-cols-[1fr_1fr]">
            ...
            <div className="relative z-10 bg-white py-8 pr-0 sm:py-10 lg:py-12 lg:pr-10 xl:py-14">
              ...
              <p className="max-w-2xl leading-[1.65] text-gray-700">
                Orion Pest Solutions is an established pest control company in Nagpur dedicated to keeping homes, housing societies, and industrial premises pest-free. Our certified technicians combine scientific pest management, eco-friendly formulations, and precision treatment methods to ensure clean, protected spaces.
              </p>
                ...
                <div className="relative mt-5 flex-1">
                  ...
                  <div className="absolute left-1/2 top-3 h-[390px] w-[90%] md:w-[78%] -translate-x-1/2 overflow-hidden sm:h-[450px] sm:w-[82%] lg:h-[440px] xl:h-[480px]">
                    <Image
                      ...
                      alt="Pest control services in Nagpur"
                      fill
                      priority
          ...
          <div className="grid gap-10 lg:gap-12 xl:grid-cols-2 items-start">
            ...
            <div>
              ...
              <p className="mt-4 sm:mt-5 max-w-lg text-lg leading-relaxed text-gray-600">
                Don&apos;t let pests compromise your family&apos;s health or business reputation. Book a professional inspection with our certified Nagpur pest control experts today.
              </p>
      ...
      >
        ...
        <div className="mx-auto max-w-[720px] text-center">
          ...
          >
            ...
            <br />
            <span className="text-[#f4bd00]">in Nagpur</span>
          </h2>
          ...
          <p
            ...
            "
          >
            From destructive termites to cockroaches, rodents, and bed bugs, explore our specialized pest control services in Nagpur designed for homes, commercial complexes, and logistics hubs.
          </p>
        </div>
      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            A systematic, hassle-free approach designed to solve pest problems quickly and keep Nagpur properties protected year-round.
          </p>
        </header>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p
                    ...
                    "
                  >
                    We protect Nagpur homes and commercial facilities with proactive pest management, using safe chemicals that keep your family, pets, and workspace secure.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              >
                <span
                  ...
                  "
                >
                  Need Immediate Assistance in Nagpur?
                </span>
