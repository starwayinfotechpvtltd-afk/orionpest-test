...
export const metadata = {
  title: "Pest Control Company in Kolhapur | 27+ Years of Trusted Pest Services - Orion Pest",
  description:
    "Looking for the top pest control company in Kolhapur? Orion Pest Solutions provides safe, odorless pest control services, termite control, cockroach removal & rodent defense across Kolhapur. 27+ years of trust. Book a free inspection today!",
};
...
const stats = [
  ...
  },
  {
    ...
    subHeading: "Across Kolhapur & Western Maharashtra",
  },
];
...
const services = [
  {
    ...
    description: "Specialized cockroach control in Kolhapur with odorless gel baits and targeted sprays for modular kitchens and commercial food areas.",
  ...
  },
  {
    ...
    description: "Advanced pre & post-construction termite control in Kolhapur to safeguard furniture, flooring, and interior woodwork.",
...
const protectionFeatures = [
  ...
  },
  {
    ...
    description:
      "Our technicians in Kolhapur are certified, background-verified, and trained in modern pest management.",
    icon: UserCheck,
  },
  {
...
const faq = [
  {
    id: "01",
    question: "Why should I choose Orion Pest Solutions in Kolhapur?",
    answer:
      "Orion Pest Solutions is an established pest control company in Kolhapur with over two decades of industry experience. We offer government-approved, low-toxicity treatments, certified local technicians, and guaranteed results tailored to Kolhapur's climate conditions.",
  },
  {
    id: "02",
    question: "How does your cockroach control in Kolhapur work?",
    answer:
  ...
  {
    id: "03",
    question: "When is the right time to get termite control in Kolhapur?",
    answer:
      "Subterranean termites are active throughout the year in Kolhapur. If you notice mud tubes along walls, hollow-sounding wooden doors, or fine wood dust, you should book a termite inspection immediately.",
  },
  {
    id: "04",
  ...
  {
    id: "06",
    question: "Which areas in Kolhapur do you serve?",
    answer:
      "We serve all major localities across Kolhapur, including Tarabai Park, Rajarampuri, Shahupuri, Nagala Park, Kasba Bawada, Shiroli MIDC, and Gokul Shirgaon MIDC.",
  },
];
            ...
            <div className="w-full space-y-8">
              ...
              <div className="space-y-2">
                <h1 className="text-[34px] sm:text-5xl w-full md:w-2xl xl:text-7xl font-bold text-[#36388D] leading-tight lg:!leading-[4.8rem]">
                  ...
                  <span className="text-[#1095D9]"> Kolhapur </span>
                </h1>
                <div className="h-[2px] w-28 bg-amber-300"></div>
              </div>

              <p className="text-lg sm:text-xl text-gray-700 font-medium leading-relaxed">
                Looking for a trusted pest control company in Kolhapur? Orion Pest Solutions offers safe, fast, and eco-friendly pest control services across Kolhapur. From residences in Tarabai Park and Rajarampuri to industrial units in Shiroli and Gokul Shirgaon MIDC, we ensure complete pest protection.
              </p>
        ...
        <div className="w-full bg-[#FDC82A] p-10 flex flex-col justify-center items-center space-y-10">
          <div className="w-[400px] md:w-[500px] h-[400px] xl:w-[600px] xl:h-[500px] relative">
            <Image
              ...
              alt="Pest control company in Kolhapur"
              fill
        ...
        <div className="w-full space-y-5 py-12 md:py-20 px-6 sm:px-10 md:px-16 lg:px-20">
          ...
          <div className="space-y-3">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-[#0D2391] font-bold leading-tight">
              ...
              <span className="text-[#FECE18]">in Kolhapur</span>
            </h2>
          </div>
          <div className="bg-[#0D2391] h-[5px] w-28 rounded"></div>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Kolhapur's rich commercial culture, sugar and foundry industries, and expanding residential neighborhoods experience ongoing pest challenges. Subterranean termites frequently damage wooden furniture, door frames, and structural woodwork, while cockroaches and rodents often infest kitchens, food processing units, and commercial godowns.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            As a premier pest control company in Kolhapur, Orion Pest Solutions brings over 27 years of proven pest management experience to your doorstep. We don't rely on temporary sprays; our certified technicians locate root nesting colonies, apply odorless, government-approved formulations, and establish deep chemical barriers. Whether you need reliable cockroach control in Kolhapur or specialized termite control in Kolhapur, our team ensures clean, long-lasting results.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Our full-spectrum pest control services in Kolhapur protect bungalows, apartments, industrial plants, restaurants, and healthcare clinics with transparent pricing and dependable warranties.
          </p>
          <Link
            href={"/about"}
                ...
                <div className="relative mt-5 flex-1">
                  ...
                  <div className="absolute left-1/2 top-3 h-[390px] w-[90%] md:w-[78%] -translate-x-1/2 overflow-hidden sm:h-[450px] sm:w-[82%] lg:h-[440px] xl:h-[480px]">
                    <Image
                      ...
                      alt="Pest control services in Kolhapur"
                      fill
                      priority
          ...
          <div className="grid gap-10 lg:gap-12 xl:grid-cols-2 items-start">
            ...
            <div>
              ...
              <p className="mt-4 sm:mt-5 max-w-lg text-lg leading-relaxed text-gray-600">
                Don&apos;t let pests compromise your family&apos;s health or business reputation. Book a professional inspection with our certified Kolhapur pest control experts today.
              </p>
      ...
      >
        ...
        <div className="mx-auto max-w-[720px] text-center">
          ...
          >
            ...
            <br />
            <span className="text-[#f4bd00]">in Kolhapur</span>
          </h2>
          ...
          <p
            ...
            "
          >
            From destructive termites to cockroaches, rodents, and bed bugs, explore our specialized pest control services in Kolhapur designed for homes, apartments, and commercial facilities.
          </p>
        </div>
      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            A systematic, hassle-free approach designed to solve pest problems quickly and keep Kolhapur properties protected year-round.
          </p>
        </header>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p
                    ...
                    "
                  >
                    We protect Kolhapur homes and commercial facilities with proactive pest management, using safe chemicals that keep your family, pets, and workspace secure.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              >
                <span
                  ...
                  "
                >
                  Need Immediate Assistance in Kolhapur?
                </span>
