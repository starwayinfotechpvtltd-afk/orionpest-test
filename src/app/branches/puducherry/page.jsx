...
export const metadata = {
  title: "Pest Control Company in Puducherry | 27+ Years of Trusted Pest Services - Orion Pest",
  description:
    "Looking for the top pest control company in Puducherry? Orion Pest Solutions provides safe, odorless pest control services, termite control, cockroach removal & rodent defense across Puducherry. 27+ years of trust. Book a free inspection today!",
};
...
const stats = [
  ...
  },
  {
    ...
    subHeading: "Across Puducherry & Auroville",
  },
];
...
const services = [
  {
    ...
    description: "Specialized cockroach control in Puducherry with odorless gel baits and targeted sprays for kitchens, cafes, and restaurants.",
  ...
  },
  {
    ...
    description: "Advanced pre & post-construction termite control in Puducherry safeguarding colonial woodwork, beams, and modern interiors.",
...
const protectionFeatures = [
  ...
  },
  {
    ...
    description:
      "Our technicians in Puducherry are certified, background-verified, and trained in modern pest management.",
    icon: UserCheck,
  },
  {
...
const faq = [
  {
    id: "01",
    question: "Why should I choose Orion Pest Solutions in Puducherry?",
    answer:
      "Orion Pest Solutions is an established pest control company in Puducherry with over two decades of industry experience. We offer government-approved, low-toxicity treatments, certified local technicians, and guaranteed results tailored to Puducherry's climate conditions.",
  },
  {
    id: "02",
    question: "How does your cockroach control in Puducherry work?",
    answer:
  ...
  {
    id: "03",
    question: "When is the right time to get termite control in Puducherry?",
    answer:
      "Subterranean termites are active throughout the year in Puducherry. If you notice mud tubes along walls, hollow-sounding wooden doors, or fine wood dust, you should book a termite inspection immediately.",
  },
  {
    id: "04",
  ...
  {
    id: "06",
    question: "Which areas in Puducherry do you serve?",
    answer:
      "We serve properties across Puducherry, including White Town, Heritage Town, Lawspet, Muthialpet, Saram, Reddiarpalayam, Villianur, and Auroville.",
  },
];
            ...
            <div className="w-full space-y-8">
              ...
              <div className="space-y-2">
                <h1 className="text-[34px] sm:text-5xl w-full md:w-2xl xl:text-7xl font-bold text-[#36388D] leading-tight lg:!leading-[4.8rem]">
                  ...
                  <span className="text-[#1095D9]"> Puducherry </span>
                </h1>
                <div className="h-[2px] w-28 bg-amber-300"></div>
              </div>

              <p className="text-lg sm:text-xl text-gray-700 font-medium leading-relaxed">
                Looking for a trusted pest control company in Puducherry? Orion Pest Solutions offers safe, fast, and eco-friendly pest control services across Pondicherry. From French Quarter heritage villas in White Town to beachfront resorts and modern homes, we keep your property pest-free.
              </p>
        ...
        <div className="w-full bg-[#FDC82A] p-10 flex flex-col justify-center items-center space-y-10">
          <div className="w-[400px] md:w-[500px] h-[400px] xl:w-[600px] xl:h-[500px] relative">
            <Image
              ...
              alt="Pest control company in Puducherry"
              fill
        ...
        <div className="w-full space-y-5 py-12 md:py-20 px-6 sm:px-10 md:px-16 lg:px-20">
          ...
          <div className="space-y-3">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-[#0D2391] font-bold leading-tight">
              ...
              <span className="text-[#FECE18]">in Puducherry</span>
            </h2>
          </div>
          <div className="bg-[#0D2391] h-[5px] w-28 rounded"></div>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Puducherry's warm coastal climate, sea humidity, and vintage French-colonial architecture create favorable breeding grounds for termites and common urban pests. Subterranean termites and wood borers frequently damage antique doors, wooden rafters, and furniture, while cockroaches, mosquitoes, and rodents trouble residential kitchens and seaside cafes.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            As a leading pest control company in Puducherry, Orion Pest Solutions combines 27+ years of experience with eco-conscious treatment methods. We use odorless, government-approved formulations that protect delicate heritage woodwork and modern interiors without releasing toxic odors. Whether you require specialized termite control in Puducherry or prompt cockroach control in Puducherry, our certified team delivers dependable results.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Our full suite of pest control services in Puducherry protects heritage homes, boutique hotels, cafes, apartments, and commercial complexes with transparent pricing and service warranties.
          </p>
          <Link
            href={"/about"}
          ...
          <div className="grid overflow-hidden rounded-[28px] lg:grid-cols-[1fr_1fr]">
            ...
            <div className="relative z-10 bg-white py-8 pr-0 sm:py-10 lg:py-12 lg:pr-10 xl:py-14">
              ...
              <p className="max-w-2xl leading-[1.65] text-gray-700">
                Orion Pest Solutions is an established pest control company in Puducherry dedicated to keeping heritage properties, boutique resorts, and homes pest-free. Our certified technicians combine scientific pest management, eco-friendly formulations, and precision treatment methods to ensure clean, healthy spaces.
              </p>
                ...
                <div className="relative mt-5 flex-1">
                  ...
                  <div className="absolute left-1/2 top-3 h-[390px] w-[90%] md:w-[78%] -translate-x-1/2 overflow-hidden sm:h-[450px] sm:w-[82%] lg:h-[440px] xl:h-[480px]">
                    <Image
                      ...
                      alt="Pest control services in Puducherry"
                      fill
                      priority
          ...
          <div className="grid gap-10 lg:gap-12 xl:grid-cols-2 items-start">
            ...
            <div>
              ...
              <p className="mt-4 sm:mt-5 max-w-lg text-lg leading-relaxed text-gray-600">
                Don&apos;t let pests compromise your family&apos;s health or business reputation. Book a professional inspection with our certified Puducherry pest control experts today.
              </p>
      ...
      >
        ...
        <div className="mx-auto max-w-[720px] text-center">
          ...
          >
            ...
            <br />
            <span className="text-[#f4bd00]">in Puducherry</span>
          </h2>
          ...
          <p
            ...
            "
          >
            From timber-damaging termites to cockroaches and rodents, explore our specialized pest control services in Puducherry designed for heritage villas, beach resorts, and residential homes.
          </p>
        </div>
      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            A systematic, hassle-free approach designed to solve pest problems quickly and keep Puducherry properties protected year-round.
          </p>
        </header>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p
                    ...
                    "
                  >
                    We protect Puducherry homes and commercial facilities with proactive pest management, using safe chemicals that keep your family, pets, and workspace secure.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              >
                <span
                  ...
                  "
                >
                  Need Immediate Assistance in Puducherry?
                </span>
