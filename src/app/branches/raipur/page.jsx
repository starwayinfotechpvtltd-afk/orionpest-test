...
export const metadata = {
  title: "Pest Control Company in Raipur | 27+ Years of Trusted Pest Services - Orion Pest",
  description:
    "Looking for the top pest control company in Raipur? Orion Pest Solutions provides safe, odorless pest control services, termite control, cockroach removal & rodent defense across Raipur. 27+ years of trust. Book a free inspection today!",
};
...
const stats = [
  ...
  },
  {
    ...
    subHeading: "Across Raipur & Naya Raipur",
  },
];
...
const services = [
  {
    ...
    description: "Specialized cockroach control in Raipur using odorless gel baits and targeted sprays for modular kitchens and food spaces.",
  ...
  },
  {
    ...
    description: "Advanced pre & post-construction termite control in Raipur to safeguard furniture, flooring, and interior woodwork.",
...
const protectionFeatures = [
  ...
  },
  {
    ...
    description:
      "Our technicians in Raipur are certified, background-verified, and trained in modern pest management.",
    icon: UserCheck,
  },
  {
...
const faq = [
  {
    id: "01",
    question: "Why should I choose Orion Pest Solutions in Raipur?",
    answer:
      "Orion Pest Solutions is an established pest control company in Raipur with over two decades of industry experience. We offer government-approved, low-toxicity treatments, certified local technicians, and guaranteed results tailored to Raipur's climate conditions.",
  },
  {
    id: "02",
    question: "How does your cockroach control in Raipur work?",
    answer:
  ...
  {
    id: "03",
    question: "When is the right time to get termite control in Raipur?",
    answer:
      "Subterranean termites are active throughout the year in Raipur. If you notice mud tubes along walls, hollow-sounding wooden doors, or fine wood dust, you should book a termite inspection immediately.",
  },
  {
    id: "04",
  ...
  {
    id: "06",
    question: "Which areas in Raipur do you serve?",
    answer:
      "We serve all residential and commercial zones across Raipur, including Shankar Nagar, VIP Road, Telibandha, Devendra Nagar, Pandri, Tatibandh, Samta Colony, Urla, and Naya Raipur.",
  },
];
            ...
            <div className="w-full space-y-8">
              ...
              <div className="space-y-2">
                <h1 className="text-[34px] sm:text-5xl w-full md:w-2xl xl:text-7xl font-bold text-[#36388D] leading-tight lg:!leading-[4.8rem]">
                  ...
                  <span className="text-[#1095D9]"> Raipur </span>
                </h1>
                <div className="h-[2px] w-28 bg-amber-300"></div>
              </div>

              <p className="text-lg sm:text-xl text-gray-700 font-medium leading-relaxed">
                Looking for a trusted pest control company in Raipur? Orion Pest Solutions delivers safe, fast, and eco-friendly pest control services across Raipur and Naya Raipur. From residences in Shankar Nagar and VIP Road to industrial plants in Urla and Bhanpuri, we ensure complete pest protection.
              </p>
        ...
        <div className="w-full bg-[#FDC82A] p-10 flex flex-col justify-center items-center space-y-10">
          <div className="w-[400px] md:w-[500px] h-[400px] xl:w-[600px] xl:h-[500px] relative">
            <Image
              ...
              alt="Pest control company in Raipur"
              fill
        ...
        <div className="w-full space-y-5 py-12 md:py-20 px-6 sm:px-10 md:px-16 lg:px-20">
          ...
          <div className="space-y-3">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-[#0D2391] font-bold leading-tight">
              ...
              <span className="text-[#FECE18]">in Raipur</span>
            </h2>
          </div>
          <div className="bg-[#0D2391] h-[5px] w-28 rounded"></div>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Raipur's position as a major industrial and commercial hub in Chhattisgarh, coupled with warm weather and monsoon moisture, leads to active pest breeding. Subterranean termites pose severe threats to wooden door frames, flooring, and cabinetry, while cockroaches, rodents, and bed bugs frequently infest residential colonies and commercial offices.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            As a leading pest control company in Raipur, Orion Pest Solutions brings over 27 years of specialized pest management experience. We locate root nesting colonies, apply odorless, government-approved formulations, and establish deep chemical barriers to ensure pests do not return. Whether you need reliable cockroach control in Raipur or comprehensive termite control in Raipur, our certified local team ensures guaranteed protection.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Our full-spectrum pest control services in Raipur protect independent bungalows, apartments, industrial warehouses, steel plants, and hospitals with transparent pricing and full service warranties.
          </p>
          <Link
            href={"/about"}
                ...
                <div className="relative mt-5 flex-1">
                  ...
                  <div className="absolute left-1/2 top-3 h-[390px] w-[90%] md:w-[78%] -translate-x-1/2 overflow-hidden sm:h-[450px] sm:w-[82%] lg:h-[440px] xl:h-[480px]">
                    <Image
                      ...
                      alt="Pest control services in Raipur"
                      fill
                      priority
          ...
          <div className="grid gap-10 lg:gap-12 xl:grid-cols-2 items-start">
            ...
            <div>
              ...
              <p className="mt-4 sm:mt-5 max-w-lg text-lg leading-relaxed text-gray-600">
                Don&apos;t let pests compromise your family&apos;s health or business reputation. Book a professional inspection with our certified Raipur pest control experts today.
              </p>
      ...
      >
        ...
        <div className="mx-auto max-w-[720px] text-center">
          ...
          >
            ...
            <br />
            <span className="text-[#f4bd00]">in Raipur</span>
          </h2>
          ...
          <p
            ...
            "
          >
            From destructive termites to cockroaches, rodents, and bed bugs, explore our professional pest control services in Raipur tailored for residences, commercial buildings, and industrial plants.
          </p>
        </div>
      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            A systematic, hassle-free approach designed to solve pest problems quickly and keep Raipur properties protected year-round.
          </p>
        </header>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p
                    ...
                    "
                  >
                    We protect Raipur homes and commercial facilities with proactive pest management, using safe chemicals that keep your family, pets, and workspace secure.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              >
                <span
                  ...
                  "
                >
                  Need Immediate Assistance in Raipur?
                </span>
