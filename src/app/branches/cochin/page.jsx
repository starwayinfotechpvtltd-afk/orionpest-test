...
export const metadata = {
  title: "Pest Control Company in Cochin | 27+ Years of Trusted Pest Services - Orion Pest",
  description:
    "Looking for the top pest control company in Cochin? Orion Pest Solutions provides safe, odorless pest control services, termite control, cockroach removal & rodent defense across Cochin. 27+ years of trust. Book a free inspection today!",
};
...
const stats = [
  ...
  },
  {
    ...
    subHeading: "Across Kochi & Ernakulam",
  },
];
...
const services = [
  {
    ...
    description: "Specialized cockroach control in Cochin using odorless gel baits and targeted sprays for kitchens and commercial pantries.",
  ...
  },
  {
    ...
    description: "Advanced pre & post-construction termite control in Cochin to safeguard wooden interiors, door frames, and structures.",
...
const protectionFeatures = [
  ...
  },
  {
    ...
    description:
      "Our technicians in Cochin are certified, background-verified, and trained in modern pest management.",
    icon: UserCheck,
  },
  {
...
const faq = [
  {
    id: "01",
    question: "Why should I choose Orion Pest Solutions in Cochin?",
    answer:
      "Orion Pest Solutions is an established pest control company in Cochin with over two decades of industry experience. We offer government-approved, low-toxicity treatments, certified local technicians, and guaranteed results tailored to Cochin's climate conditions.",
  },
  {
    id: "02",
    question: "How does your cockroach control in Cochin work?",
    answer:
  ...
  {
    id: "03",
    question: "When is the right time to get termite control in Cochin?",
    answer:
      "Subterranean termites are active throughout the year in Cochin. If you notice mud tubes along walls, hollow-sounding wooden doors, or fine wood dust, you should book a termite inspection immediately.",
  },
  {
    id: "04",
  ...
  {
    id: "06",
    question: "Which areas in Cochin do you serve?",
    answer:
      "We serve all major localities across Kochi and Ernakulam, including Kakkanad, Marine Drive, Edappally, Palarivattom, Fort Kochi, Kadavanthra, Aluva, Kaloor, and Panampilly Nagar.",
  },
];
            ...
            <div className="w-full space-y-8">
              ...
              <div className="space-y-2">
                <h1 className="text-[34px] sm:text-5xl w-full md:w-2xl xl:text-7xl font-bold text-[#36388D] leading-tight lg:!leading-[4.8rem]">
                  ...
                  <span className="text-[#1095D9]"> Cochin </span>
                </h1>
                <div className="h-[2px] w-28 bg-amber-300"></div>
              </div>

              <p className="text-lg sm:text-xl text-gray-700 font-medium leading-relaxed">
                Looking for a trusted pest control company in Cochin? Orion Pest Solutions offers safe, fast, and eco-friendly pest control services across Kochi and Ernakulam. From waterfront residences in Marine Drive to IT offices in Kakkanad and commercial spaces in Edappally, we keep your spaces pest-free.
              </p>
        ...
        <div className="w-full bg-[#FDC82A] p-10 flex flex-col justify-center items-center space-y-10">
          <div className="w-[400px] md:w-[500px] h-[400px] xl:w-[600px] xl:h-[500px] relative">
            <Image
              ...
              alt="Pest control company in Cochin"
              fill
        ...
        <div className="w-full space-y-5 py-12 md:py-20 px-6 sm:px-10 md:px-16 lg:px-20">
          ...
          <div className="space-y-3">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-[#0D2391] font-bold leading-tight">
              ...
              <span className="text-[#FECE18]">in Cochin</span>
            </h2>
          </div>
          <div className="bg-[#0D2391] h-[5px] w-28 rounded"></div>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Cochin's tropical coastal climate, high humidity, and backwater surroundings create severe pest challenges. Subterranean termites and wood borers thrive in humid conditions, causing extensive damage to wooden furniture and door frames, while cockroaches, mosquitoes, and rodents constantly trouble homes, restaurants, and commercial facilities.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            As a premier pest control company in Cochin, Orion Pest Solutions brings over 27 years of proven pest management experience to your doorstep. We apply odorless, government-approved formulations and precision baiting techniques to destroy root breeding nests safely. Whether you require prompt cockroach control in Cochin or specialized termite control in Cochin, our certified local team delivers clean, long-lasting results.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Our comprehensive pest control services in Cochin protect independent villas, apartments, hotels, healthcare facilities, and port warehouses with upfront pricing and service warranties.
          </p>
          <Link
            href={"/about"}
          ...
          <div className="grid overflow-hidden rounded-[28px] lg:grid-cols-[1fr_1fr]">
            ...
            <div className="relative z-10 bg-white py-8 pr-0 sm:py-10 lg:py-12 lg:pr-10 xl:py-14">
              ...
              <p className="max-w-2xl leading-[1.65] text-gray-700">
                Orion Pest Solutions is an established pest control company in Cochin dedicated to keeping residences, resorts, offices, and commercial facilities pest-free. Our certified technicians combine scientific pest management, eco-friendly formulations, and precision treatment methods to ensure clean, healthy environments.
              </p>
                ...
                <div className="relative mt-5 flex-1">
                  ...
                  <div className="absolute left-1/2 top-3 h-[390px] w-[90%] md:w-[78%] -translate-x-1/2 overflow-hidden sm:h-[450px] sm:w-[82%] lg:h-[440px] xl:h-[480px]">
                    <Image
                      ...
                      alt="Pest control services in Cochin"
                      fill
                      priority
          ...
          <div className="grid gap-10 lg:gap-12 xl:grid-cols-2 items-start">
            ...
            <div>
              ...
              <p className="mt-4 sm:mt-5 max-w-lg text-lg leading-relaxed text-gray-600">
                Don&apos;t let pests compromise your family&apos;s health or business reputation. Book a professional inspection with our certified Cochin pest control experts today.
              </p>
      ...
      >
        ...
        <div className="mx-auto max-w-[720px] text-center">
          ...
          >
            ...
            <br />
            <span className="text-[#f4bd00]">in Cochin</span>
          </h2>
          ...
          <p
            ...
            "
          >
            From timber-damaging termites to cockroaches and rodents, explore our professional pest control services in Cochin tailored for homes, apartments, hotels, and commercial establishments.
          </p>
        </div>
      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            A systematic, hassle-free approach designed to solve pest problems quickly and keep Cochin properties protected year-round.
          </p>
        </header>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p
                    ...
                    "
                  >
                    We protect Cochin homes and commercial facilities with proactive pest management, using safe chemicals that keep your family, pets, and workspace secure.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              >
                <span
                  ...
                  "
                >
                  Need Immediate Assistance in Cochin?
                </span>
