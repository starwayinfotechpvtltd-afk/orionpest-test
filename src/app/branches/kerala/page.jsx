...
export const metadata = {
  title: "Pest Control Company in Kerala | 27+ Years of Trusted Pest Services - Orion Pest",
  description:
    "Looking for the top pest control company in Kerala? Orion Pest Solutions provides safe, odorless pest control services, termite control, cockroach removal & rodent defense across Kerala. 27+ years of trust. Book a free inspection today!",
};
...
const stats = [
  ...
  },
  {
    ...
    subHeading: "Across Kerala State",
  },
];
...
const stats3 = [
  ...
  {
    icon: <UsersRound />,
    heading: "Kerala Regional Operations",
...
const services = [
  {
    ...
    description: "Specialized cockroach control in Kerala using odorless gel baits and targeted applications for kitchens and hospitality venues.",
  ...
  },
  {
    ...
    description: "Advanced pre & post-construction termite control in Kerala safeguarding timber structures, wooden ceilings, and interior woodwork.",
...
const protectionFeatures = [
  ...
  },
  {
    ...
    description:
      "Our technicians in Kerala are certified, background-verified, and trained in modern pest management.",
    icon: UserCheck,
  },
  {
...
const faq = [
  {
    id: "01",
    question: "Why should I choose Orion Pest Solutions in Kerala?",
    answer:
      "Orion Pest Solutions is an established pest control company in Kerala with over two decades of industry experience. We offer government-approved, low-toxicity treatments, certified local technicians, and guaranteed results tailored to Kerala's climate conditions.",
  },
  {
    id: "02",
    question: "How does your cockroach control in Kerala work?",
    answer:
  ...
  {
    id: "03",
    question: "When is the right time to get termite control in Kerala?",
    answer:
      "Subterranean termites are active throughout the year in Kerala. If you notice mud tubes along walls, hollow-sounding wooden doors, or fine wood dust, you should book a termite inspection immediately.",
  },
  {
    id: "04",
  ...
  },
  {
    ...
    answer:
      "We provide comprehensive pest management across key districts in Kerala, including Ernakulam/Kochi, Thiruvananthapuram, Kozhikode, Thrissur, Kottayam, Kollam, Palakkad, and Alappuzha.",
  },
];
            ...
            <div className="w-full space-y-8">
              ...
              <div className="space-y-2">
                <h1 className="text-[34px] sm:text-5xl w-full md:w-2xl xl:text-7xl font-bold text-[#36388D] leading-tight lg:!leading-[4.8rem]">
                  ...
                  <span className="text-[#1095D9]"> Kerala </span>
                </h1>
                <div className="h-[2px] w-28 bg-amber-300"></div>
              </div>

              <p className="text-lg sm:text-xl text-gray-700 font-medium leading-relaxed">
                Looking for a trusted pest control company in Kerala? Orion Pest Solutions delivers safe, fast, and eco-friendly pest control services across Kerala. From traditional wooden homes and luxury backwater resorts to commercial complexes, we ensure complete protection against unwanted pests.
              </p>
        ...
        <div className="w-full bg-[#FDC82A] p-10 flex flex-col justify-center items-center space-y-10">
          <div className="w-[400px] md:w-[500px] h-[400px] xl:w-[600px] xl:h-[500px] relative">
            <Image
              ...
              alt="Pest control company in Kerala"
              fill
        ...
        <div className="w-full space-y-5 py-12 md:py-20 px-6 sm:px-10 md:px-16 lg:px-20">
          ...
          <div className="space-y-3">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-[#0D2391] font-bold leading-tight">
              ...
              <span className="text-[#FECE18]">in Kerala</span>
            </h2>
          </div>
          <div className="bg-[#0D2391] h-[5px] w-28 rounded"></div>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Kerala's heavy monsoon rainfall, tropical humidity, and traditional timber-heavy architecture make homes and commercial properties particularly prone to pest infestations. Subterranean termites and wood borers cause catastrophic damage to wooden roofs, beams, and furniture, while mosquitoes, cockroaches, and rodents disrupt daily comfort and commercial operations.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            As a leading pest control company in Kerala, Orion Pest Solutions combines over 27 years of field expertise with eco-safe, government-approved treatment methods. We don't rely on temporary sprays; our certified technicians target root breeding nests and establish deep preventive barriers that withstand Kerala's rainy climate. Whether you require specialized termite control in Kerala or prompt cockroach control in Kerala, our team delivers guaranteed protection.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Our comprehensive pest control services in Kerala cater to private homes, heritage properties, resorts, Ayurvedic centers, and commercial establishments with transparent pricing and full service warranties.
          </p>
          <Link
            href={"/about"}
          ...
          <div className="grid overflow-hidden rounded-[28px] lg:grid-cols-[1fr_1fr]">
            ...
            <div className="relative z-10 bg-white py-8 pr-0 sm:py-10 lg:py-12 lg:pr-10 xl:py-14">
              ...
              <p className="max-w-2xl leading-[1.65] text-gray-700">
                Orion Pest Solutions is an established pest control company in Kerala dedicated to keeping residential communities, eco-resorts, and commercial facilities pest-free. Our certified technicians combine scientific pest management, eco-friendly formulations, and precision treatment methods to ensure clean, healthy spaces.
              </p>
                ...
                <div className="relative mt-5 flex-1">
                  ...
                  <div className="absolute left-1/2 top-3 h-[390px] w-[90%] md:w-[78%] -translate-x-1/2 overflow-hidden sm:h-[450px] sm:w-[82%] lg:h-[440px] xl:h-[480px]">
                    <Image
                      ...
                      alt="Pest control services in Kerala"
                      fill
                      priority
          ...
          <div className="grid gap-10 lg:gap-12 xl:grid-cols-2 items-start">
            ...
            <div>
              ...
              <p className="mt-4 sm:mt-5 max-w-lg text-lg leading-relaxed text-gray-600">
                Don&apos;t let pests compromise your family&apos;s health or business reputation. Book a professional inspection with our certified Kerala pest control experts today.
              </p>
      ...
      >
        ...
        <div className="mx-auto max-w-[720px] text-center">
          ...
          >
            ...
            <br />
            <span className="text-[#f4bd00]">in Kerala</span>
          </h2>
          ...
          <p
            ...
            "
          >
            From timber-damaging termites to cockroaches, mosquitoes, and rodents, explore our specialized pest control services in Kerala designed for homes, backwater resorts, and commercial properties.
          </p>
        </div>
      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            A systematic, hassle-free approach designed to solve pest problems quickly and keep Kerala properties protected year-round.
          </p>
        </header>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p
                    ...
                    "
                  >
                    We protect Kerala homes and commercial facilities with proactive pest management, using safe chemicals that keep your family, pets, and workspace secure.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              >
                <span
                  ...
                  "
                >
                  Need Immediate Assistance in Kerala?
                </span>
