...
export const metadata = {
  title: "Pest Control Company in Ranchi | 27+ Years of Trusted Pest Services - Orion Pest",
  description:
    "Looking for the top pest control company in Ranchi? Orion Pest Solutions provides safe, odorless pest control services, termite control, cockroach removal & rodent defense across Ranchi. 27+ years of trust. Book a free inspection today!",
};
...
const services = [
  {
    ...
    description: "Specialized cockroach control in Ranchi using odorless gel baits and targeted sprays for modular kitchens and commercial food spaces.",
  ...
  },
  {
    ...
    description: "Advanced pre & post-construction termite control in Ranchi to safeguard furniture, flooring, and interior woodwork.",
...
const protectionFeatures = [
  ...
  },
  {
    ...
    description:
      "Our technicians in Ranchi are certified, background-verified, and trained in modern pest management.",
    icon: UserCheck,
  },
  {
...
const faq = [
  {
    id: "01",
    question: "Why should I choose Orion Pest Solutions in Ranchi?",
    answer:
      "Orion Pest Solutions is an established pest control company in Ranchi with over two decades of industry experience. We offer government-approved, low-toxicity treatments, certified local technicians, and guaranteed results tailored to Ranchi's climate conditions.",
  },
  {
    id: "02",
    question: "How does your cockroach control in Ranchi work?",
    answer:
  ...
  {
    id: "03",
    question: "When is the right time to get termite control in Ranchi?",
    answer:
      "Subterranean termites are active throughout the year in Ranchi. If you notice mud tubes along walls, hollow-sounding wooden doors, or fine wood dust, you should book a termite inspection immediately.",
  },
  {
    id: "04",
  ...
  },
  {
    ...
    answer:
      "We serve all residential and commercial zones across Ranchi, including Harmu, Morabadi, Lalpur, Doranda, Ashok Nagar, Kanke Road, Bariatu, Hinoo, and Ratu Road.",
  },
];
            ...
            <div className="w-full space-y-8">
              ...
              <div className="space-y-2">
                <h1 className="text-[34px] sm:text-5xl w-full md:w-2xl xl:text-7xl font-bold text-[#36388D] leading-tight lg:!leading-[4.8rem]">
                  ...
                  <span className="text-[#1095D9]"> Ranchi </span>
                </h1>
                <div className="h-[2px] w-28 bg-amber-300"></div>
              </div>

              <p className="text-lg sm:text-xl text-gray-700 font-medium leading-relaxed">
                Looking for a trusted pest control company in Ranchi? Orion Pest Solutions provides safe, fast, and eco-friendly pest control services across Ranchi. From residences in Harmu and Morabadi to commercial establishments in Lalpur and Doranda, we keep your spaces pest-free.
              </p>
        ...
        <div className="w-full bg-[#FDC82A] p-10 flex flex-col justify-center items-center space-y-10">
          <div className="w-[400px] md:w-[500px] h-[400px] xl:w-[600px] xl:h-[500px] relative">
            <Image
              ...
              alt="Pest control company in Ranchi"
              fill
        ...
        <div className="w-full space-y-5 py-12 md:py-20 px-6 sm:px-10 md:px-16 lg:px-20">
          ...
          <div className="space-y-3">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-[#0D2391] font-bold leading-tight">
              ...
              <span className="text-[#FECE18]">in Ranchi</span>
            </h2>
          </div>
          <div className="bg-[#0D2391] h-[5px] w-28 rounded"></div>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Ranchi's plateau climate, seasonal humidity, and rapidly expanding residential townships create conditions where pests can multiply quickly. Subterranean termites frequently damage wooden doors, cabinets, and structural fittings, while cockroaches and rodents often invade kitchens, pantries, and commercial establishments.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            As an established pest control company in Ranchi, Orion Pest Solutions delivers scientifically proven, odorless treatments with over 27 years of industry excellence. We apply government-approved, low-toxicity formulations directly to nesting zones and create long-lasting chemical barriers that protect your property against termite damage. Whether you require prompt cockroach control in Ranchi or specialized termite control in Ranchi, our certified local team ensures dependable results.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Our full-spectrum pest control services in Ranchi protect bungalows, apartments, hotels, healthcare facilities, and offices with upfront pricing and service guarantees.
          </p>
          <Link
            href={"/about"}
          ...
          <div className="grid overflow-hidden rounded-[28px] lg:grid-cols-[1fr_1fr]">
            ...
            <div className="relative z-10 bg-white py-8 pr-0 sm:py-10 lg:py-12 lg:pr-10 xl:py-14">
              ...
              <p className="max-w-2xl leading-[1.65] text-gray-700">
                Orion Pest Solutions is an established pest control company in Ranchi dedicated to keeping homes, residential societies, and commercial properties pest-free. Our certified technicians combine scientific pest management, eco-friendly formulations, and precision treatment methods to ensure clean, healthy spaces.
              </p>
                ...
                <div className="relative mt-5 flex-1">
                  ...
                  <div className="absolute left-1/2 top-3 h-[390px] w-[90%] md:w-[78%] -translate-x-1/2 overflow-hidden sm:h-[450px] sm:w-[82%] lg:h-[440px] xl:h-[480px]">
                    <Image
                      ...
                      alt="Pest control services in Ranchi"
                      fill
                      priority
          ...
          <div className="grid gap-10 lg:gap-12 xl:grid-cols-2 items-start">
            ...
            <div>
              ...
              <p className="mt-4 sm:mt-5 max-w-lg text-lg leading-relaxed text-gray-600">
                Don&apos;t let pests compromise your family&apos;s health or business reputation. Book a professional inspection with our certified Ranchi pest control experts today.
              </p>
      ...
      >
        ...
        <div className="mx-auto max-w-[720px] text-center">
          ...
          >
            ...
            <br />
            <span className="text-[#f4bd00]">in Ranchi</span>
          </h2>
          ...
          <p
            ...
            "
          >
            From destructive termites to cockroaches, rodents, and bed bugs, explore our professional pest control services in Ranchi designed for homes, apartments, and commercial facilities.
          </p>
        </div>
      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            A systematic, hassle-free approach designed to solve pest problems quickly and keep Ranchi properties protected year-round.
          </p>
        </header>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p
                    ...
                    "
                  >
                    We protect Ranchi homes and commercial facilities with proactive pest management, using safe chemicals that keep your family, pets, and workspace secure.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              >
                <span
                  ...
                  "
                >
                  Need Immediate Assistance in Ranchi?
                </span>
