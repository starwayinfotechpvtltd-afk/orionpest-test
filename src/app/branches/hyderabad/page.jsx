...
export const metadata = {
  title: "Pest Control Company in Hyderabad | 27+ Years of Trusted Pest Services - Orion Pest",
  description:
    "Looking for the top pest control company in Hyderabad? Orion Pest Solutions provides safe, odorless pest control services, termite control, cockroach removal & rodent defense across Hyderabad. 27+ years of trust. Book a free inspection today!",
};
...
const stats = [
  ...
  },
  {
    ...
    subHeading: "Across Hyderabad & Secunderabad",
  },
];
...
const services = [
  {
    ...
    description: "Specialized cockroach control in Hyderabad with odorless gel baits and targeted sprays for modern modular kitchens.",
  ...
  },
  {
    ...
    description: "Advanced pre & post-construction termite control in Hyderabad to safeguard furniture, flooring, and interior woodwork.",
...
const protectionFeatures = [
  ...
  },
  {
    ...
    description:
      "Our technicians in Hyderabad are certified, background-verified, and trained in modern pest management.",
    icon: UserCheck,
  },
  {
...
const faq = [
  {
    id: "01",
    question: "Why should I choose Orion Pest Solutions in Hyderabad?",
    answer:
      "Orion Pest Solutions is an established pest control company in Hyderabad with over two decades of industry experience. We offer government-approved, low-toxicity treatments, certified local technicians, and guaranteed results tailored to Hyderabad's climate conditions.",
  },
  {
    id: "02",
    question: "How does your cockroach control in Hyderabad work?",
    answer:
  ...
  {
    id: "03",
    question: "When is the right time to get termite control in Hyderabad?",
    answer:
      "Subterranean termites are active throughout the year in Hyderabad. If you notice mud tubes along walls, hollow-sounding wooden doors, or fine wood dust, you should book a termite inspection immediately.",
  },
  {
    id: "04",
  ...
  },
  {
    ...
    answer:
      "We serve all residential and commercial zones across Hyderabad, including Gachibowli, Hitec City, Madhapur, Kondapur, Banjara Hills, Jubilee Hills, Kukatpally, Secunderabad, Miyapur, and Begumpet.",
  },
];
            ...
            <div className="w-full space-y-8">
              ...
              <div className="space-y-2">
                <h1 className="text-[34px] sm:text-5xl w-full md:w-2xl xl:text-7xl font-bold text-[#36388D] leading-tight lg:!leading-[4.8rem]">
                  ...
                  <span className="text-[#1095D9]"> Hyderabad </span>
                </h1>
                <div className="h-[2px] w-28 bg-amber-300"></div>
              </div>

              <p className="text-lg sm:text-xl text-gray-700 font-medium leading-relaxed">
                Looking for a trusted pest control company in Hyderabad? Orion Pest Solutions delivers safe, fast, and eco-friendly pest control services across Hyderabad and Secunderabad. From luxury apartments in Gachibowli and Hitec City to independent homes in Banjara Hills and Jubilee Hills, we ensure complete pest relief.
              </p>
        ...
        <div className="w-full bg-[#FDC82A] p-10 flex flex-col justify-center items-center space-y-10">
          <div className="w-[400px] md:w-[500px] h-[400px] xl:w-[600px] xl:h-[500px] relative">
            <Image
              ...
              alt="Pest control company in Hyderabad"
              fill
        ...
        <div className="w-full space-y-5 py-12 md:py-20 px-6 sm:px-10 md:px-16 lg:px-20">
          ...
          <div className="space-y-3">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-[#0D2391] font-bold leading-tight">
              ...
              <span className="text-[#FECE18]">in Hyderabad</span>
            </h2>
          </div>
          <div className="bg-[#0D2391] h-[5px] w-28 rounded"></div>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Hyderabad's rapidly expanding residential sectors, bustling IT corridors, and warm climate create active breeding zones for common household and commercial pests. German cockroaches frequently infest modular kitchens and pantries, while subterranean termites cause extensive damage to false ceilings, wooden doors, and modular furniture in newly built apartments and villas.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            As a premier pest control company in Hyderabad, Orion Pest Solutions brings over 27 years of proven industry excellence to your doorstep. We utilize scientific inspection protocols, odorless gel baits, and drill-fill-seal termite barriers that eradicate pests without causing mess or toxic fumes. Whether you require prompt cockroach control in Hyderabad or specialized termite control in Hyderabad, our certified local team ensures long-lasting results.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Our comprehensive pest control services in Hyderabad cater to gated communities, corporate IT parks, restaurants, hospitals, and manufacturing units with transparent pricing and prompt service.
          </p>
          <Link
            href={"/about"}
          ...
          <div className="grid overflow-hidden rounded-[28px] lg:grid-cols-[1fr_1fr]">
            ...
            <div className="relative z-10 bg-white py-8 pr-0 sm:py-10 lg:py-12 lg:pr-10 xl:py-14">
              ...
              <p className="max-w-2xl leading-[1.65] text-gray-700">
                Orion Pest Solutions is an established pest control company in Hyderabad dedicated to keeping residential communities, corporate offices, and commercial facilities pest-free. Our certified technicians combine scientific pest management, eco-friendly formulations, and precision treatment methods to ensure clean, healthy, and protected environments.
              </p>
                ...
                <div className="relative mt-5 flex-1">
                  ...
                  <div className="absolute left-1/2 top-3 h-[390px] w-[90%] md:w-[78%] -translate-x-1/2 overflow-hidden sm:h-[450px] sm:w-[82%] lg:h-[440px] xl:h-[480px]">
                    <Image
                      ...
                      alt="Pest control services in Hyderabad"
                      fill
                      priority
          ...
          <div className="grid gap-10 lg:gap-12 xl:grid-cols-2 items-start">
            ...
            <div>
              ...
              <p className="mt-4 sm:mt-5 max-w-lg text-lg leading-relaxed text-gray-600">
                Don&apos;t let pests compromise your family&apos;s health or business reputation. Book a professional inspection with our certified Hyderabad pest control experts today.
              </p>
      ...
      >
        ...
        <div className="mx-auto max-w-[720px] text-center">
          ...
          >
            ...
            <br />
            <span className="text-[#f4bd00]">in Hyderabad</span>
          </h2>
          ...
          <p
            ...
            "
          >
            From stubborn termites to pesky cockroaches, bed bugs, and rodents, explore our specialized pest control services in Hyderabad tailored for flats, luxury villas, IT offices, and commercial spaces.
          </p>
        </div>
      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            A systematic, hassle-free approach designed to solve pest problems quickly and keep Hyderabad properties protected year-round.
          </p>
        </header>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p
                    ...
                    "
                  >
                    We protect Hyderabad homes and commercial facilities with proactive pest management, using safe chemicals that keep your family, pets, and workspace secure.
                  </p>
                </div>
              </div>
