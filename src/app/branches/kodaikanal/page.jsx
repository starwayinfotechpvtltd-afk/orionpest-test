...
export const metadata = {
  title: "Pest Control Company in Kodaikanal | 27+ Years of Trusted Pest Services - Orion Pest",
  description:
    "Looking for the top pest control company in Kodaikanal? Orion Pest Solutions provides safe, odorless pest control services, termite control, cockroach removal & rodent defense across Kodaikanal. 27+ years of trust. Book a free inspection today!",
};
...
const stats = [
  ...
  },
  {
    ...
    subHeading: "Across Kodaikanal & Hill Stations",
  },
];
...
const services = [
  {
    ...
    description: "Specialized cockroach control in Kodaikanal using odorless gel baits and targeted sprays for restaurant kitchens and cottage pantries.",
  ...
  },
  {
    ...
    description: "Advanced pre & post-construction termite control in Kodaikanal to protect wooden beams, cottage floors, and furniture.",
...
const protectionFeatures = [
  ...
  },
  {
    ...
    description:
      "Our technicians in Kodaikanal are certified, background-verified, and trained in modern pest management.",
    icon: UserCheck,
  },
  {
...
const faq = [
  {
    id: "01",
    question: "Why should I choose Orion Pest Solutions in Kodaikanal?",
    answer:
      "Orion Pest Solutions is an established pest control company in Kodaikanal with over two decades of industry experience. We offer government-approved, low-toxicity treatments, certified local technicians, and guaranteed results tailored to Kodaikanal's climate conditions.",
  },
  {
    id: "02",
    question: "How does your cockroach control in Kodaikanal work?",
    answer:
  ...
  {
    id: "03",
    question: "When is the right time to get termite control in Kodaikanal?",
    answer:
      "Subterranean termites are active throughout the year in Kodaikanal. If you notice mud tubes along walls, hollow-sounding wooden doors, or fine wood dust, you should book a termite inspection immediately.",
  },
  {
    id: "04",
  ...
  {
    id: "06",
    question: "Which areas in Kodaikanal do you serve?",
    answer:
      "We serve properties across Kodaikanal, including Lake Road, Naidupuram, Convent Road, Fairy Falls, Shenbaganur, Vilpatti, and surrounding resort areas.",
  },
];
            ...
            <div className="w-full space-y-8">
              ...
              <div className="space-y-2">
                <h1 className="text-[34px] sm:text-5xl w-full md:w-2xl xl:text-7xl font-bold text-[#36388D] leading-tight lg:!leading-[4.8rem]">
                  ...
                  <span className="text-[#1095D9]"> Kodaikanal </span>
                </h1>
                <div className="h-[2px] w-28 bg-amber-300"></div>
              </div>

              <p className="text-lg sm:text-xl text-gray-700 font-medium leading-relaxed">
                Looking for a trusted pest control company in Kodaikanal? Orion Pest Solutions provides safe, fast, and eco-friendly pest control services in Kodaikanal. From heritage wooden cottages and luxury hillside resorts to residences and cafes, we keep your properties pest-free.
              </p>
        ...
        <div className="w-full bg-[#FDC82A] p-10 flex flex-col justify-center items-center space-y-10">
          <div className="w-[400px] md:w-[500px] h-[400px] xl:w-[600px] xl:h-[500px] relative">
            <Image
              ...
              alt="Pest control company in Kodaikanal"
              fill
        ...
        <div className="w-full space-y-5 py-12 md:py-20 px-6 sm:px-10 md:px-16 lg:px-20">
          ...
          <div className="space-y-3">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-[#0D2391] font-bold leading-tight">
              ...
              <span className="text-[#FECE18]">in Kodaikanal</span>
            </h2>
          </div>
          <div className="bg-[#0D2391] h-[5px] w-28 rounded"></div>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Kodaikanal's cool hill-station climate, high rainfall, and extensive use of pine and cedar wood in cottages, resorts, and homestays create unique pest vulnerabilities. Wood-boring beetles and subterranean termites damage structural timber and antique furnishings, while bed bugs and rodents frequently trouble the hospitality industry.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            As an experienced pest control company in Kodaikanal, Orion Pest Solutions provides specialized, eco-conscious pest management that respects the delicate hill-station ecology. We use low-toxicity, odorless formulations and targeted baiting systems that eliminate pests without damaging woodwork or causing harmful chemical odors. Whether you need specialized termite control in Kodaikanal or discreet cockroach control in Kodaikanal, our team ensures reliable protection.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Our tailored pest control services in Kodaikanal protect cottages, hotels, boarding schools, and restaurants with flexible off-peak scheduling and service warranties.
          </p>
          <Link
            href={"/about"}
          ...
          <div className="grid overflow-hidden rounded-[28px] lg:grid-cols-[1fr_1fr]">
            ...
            <div className="relative z-10 bg-white py-8 pr-0 sm:py-10 lg:py-12 lg:pr-10 xl:py-14">
              ...
              <p className="max-w-2xl leading-[1.65] text-gray-700">
                Orion Pest Solutions is an established pest control company in Kodaikanal dedicated to keeping cottages, resorts, and homes pest-free. Our certified specialists apply modern pest management techniques and eco-friendly formulations to ensure clean, hygienic environments.
              </p>
                ...
                <div className="relative mt-5 flex-1">
                  ...
                  <div className="absolute left-1/2 top-3 h-[390px] w-[90%] md:w-[78%] -translate-x-1/2 overflow-hidden sm:h-[450px] sm:w-[82%] lg:h-[440px] xl:h-[480px]">
                    <Image
                      ...
                      alt="Pest control services in Kodaikanal"
                      fill
                      priority
          ...
          <div className="grid gap-10 lg:gap-12 xl:grid-cols-2 items-start">
            ...
            <div>
              ...
              <p className="mt-4 sm:mt-5 max-w-lg text-lg leading-relaxed text-gray-600">
                Don&apos;t let pests compromise your family&apos;s health or business reputation. Book a professional inspection with our certified Kodaikanal pest control experts today.
              </p>
      ...
      >
        ...
        <div className="mx-auto max-w-[720px] text-center">
          ...
          >
            ...
            <br />
            <span className="text-[#f4bd00]">in Kodaikanal</span>
          </h2>
          ...
          <p
            ...
            "
          >
            From timber-boring pests to bed bugs, cockroaches, and rodents, explore our professional pest control services in Kodaikanal tailored for cottages, hotels, and residential properties.
          </p>
        </div>
      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            A systematic, hassle-free approach designed to solve pest problems quickly and keep Kodaikanal properties protected year-round.
          </p>
        </header>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p
                    ...
                    "
                  >
                    We protect Kodaikanal homes and commercial facilities with proactive pest management, using safe chemicals that keep your family, pets, and workspace secure.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              >
                <span
                  ...
                  "
                >
                  Need Immediate Assistance in Kodaikanal?
                </span>
