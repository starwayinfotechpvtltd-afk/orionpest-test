...
export const metadata = {
  title: "Pest Control Company in Mumbai | 27+ Years of Trusted Pest Services - Orion Pest",
  description:
    "Looking for the top pest control company in Mumbai? Orion Pest Solutions provides safe, odorless pest control services, termite control, cockroach removal & rodent defense across Mumbai. 27+ years of trust. Book a free inspection today!",
};
...
const services = [
  {
    ...
    description: "Specialized cockroach control in Mumbai using odorless gel baits and targeted sprays for modular kitchens and commercial galleys.",
  ...
  },
  {
    ...
    description: "Advanced pre & post-construction termite control in Mumbai safeguarding high-end woodwork, cabinets, and flooring.",
...
const protectionFeatures = [
  ...
  },
  {
    ...
    description:
      "Our technicians in Mumbai are certified, background-verified, and trained in modern pest management.",
    icon: UserCheck,
  },
  {
...
const faq = [
  {
    id: "01",
    question: "Why should I choose Orion Pest Solutions in Mumbai?",
    answer:
      "Orion Pest Solutions is an established pest control company in Mumbai with over two decades of industry experience. We offer government-approved, low-toxicity treatments, certified local technicians, and guaranteed results tailored to Mumbai's climate conditions.",
  },
  {
    id: "02",
    question: "How does your cockroach control in Mumbai work?",
    answer:
  ...
  {
    id: "03",
    question: "When is the right time to get termite control in Mumbai?",
    answer:
      "Subterranean termites are active throughout the year in Mumbai. If you notice mud tubes along walls, hollow-sounding wooden doors, or fine wood dust, you should book a termite inspection immediately.",
  },
  {
    id: "04",
  ...
  },
  {
    ...
    answer:
      "We serve all residential and commercial zones across Mumbai, including Andheri, Bandra, Borivali, Juhu, Dadar, Colaba, Powai, Thane, Navi Mumbai, and Chembur.",
  },
];
            ...
            <div className="w-full space-y-8">
              ...
              <div className="space-y-2">
                <h1 className="text-[34px] sm:text-5xl w-full md:w-2xl xl:text-7xl font-bold text-[#36388D] leading-tight lg:!leading-[4.8rem]">
                  ...
                  <span className="text-[#1095D9]"> Mumbai </span>
                </h1>
                <div className="h-[2px] w-28 bg-amber-300"></div>
              </div>

              <p className="text-lg sm:text-xl text-gray-700 font-medium leading-relaxed">
                Looking for a trusted pest control company in Mumbai? Orion Pest Solutions delivers safe, fast, and eco-friendly pest control services across the Mumbai Metropolitan Region. From sea-facing high-rises in Bandra and South Mumbai to busy apartments in Andheri, Borivali, and Navi Mumbai, we keep your spaces pest-free.
              </p>
        ...
        <div className="w-full bg-[#FDC82A] p-10 flex flex-col justify-center items-center space-y-10">
          <div className="w-[400px] md:w-[500px] h-[400px] xl:w-[600px] xl:h-[500px] relative">
            <Image
              ...
              alt="Pest control company in Mumbai"
              fill
        ...
        <div className="w-full space-y-5 py-12 md:py-20 px-6 sm:px-10 md:px-16 lg:px-20">
          ...
          <div className="space-y-3">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-[#0D2391] font-bold leading-tight">
              ...
              <span className="text-[#FECE18]">in Mumbai</span>
            </h2>
          </div>
          <div className="bg-[#0D2391] h-[5px] w-28 rounded"></div>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Mumbai's coastal humidity, heavy monsoon downpours, and compact high-density living create ideal conditions for pests to thrive year-round. German cockroaches plague modular kitchens and apartment drainage lines, bed bugs disrupt sleep in high-rise residences, and subterranean termites secretly hollow out premium woodwork and wooden paneling.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            As a leading pest control company in Mumbai, Orion Pest Solutions brings over 27 years of expertise directly to your home or business. We utilize odorless, government-approved formulations and scientific baiting systems that tackle root nests without requiring you to vacate your flat. Whether you need urgent cockroach control in Mumbai or comprehensive termite control in Mumbai, our certified technicians deliver dependable protection.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Our full suite of pest control services in Mumbai covers residential flats, gated housing societies, restaurants, film studios, and commercial towers across the MMR with transparent pricing and prompt warranty support.
          </p>
          <Link
            href={"/about"}
          ...
          <div className="grid overflow-hidden rounded-[28px] lg:grid-cols-[1fr_1fr]">
            ...
            <div className="relative z-10 bg-white py-8 pr-0 sm:py-10 lg:py-12 lg:pr-10 xl:py-14">
              ...
              <p className="max-w-2xl leading-[1.65] text-gray-700">
                Orion Pest Solutions is an established pest control company in Mumbai trusted by thousands of homeowners, residential societies, and commercial enterprises. Our certified technicians combine scientific pest management, eco-friendly formulations, and precision treatment methods to ensure clean, healthy, and protected environments.
              </p>
                ...
                <div className="relative mt-5 flex-1">
                  ...
                  <div className="absolute left-1/2 top-3 h-[390px] w-[90%] md:w-[78%] -translate-x-1/2 overflow-hidden sm:h-[450px] sm:w-[82%] lg:h-[440px] xl:h-[480px]">
                    <Image
                      ...
                      alt="Pest control services in Mumbai"
                      fill
                      priority
          ...
          <div className="grid gap-10 lg:gap-12 xl:grid-cols-2 items-start">
            ...
            <div>
              ...
              <p className="mt-4 sm:mt-5 max-w-lg text-lg leading-relaxed text-gray-600">
                Don&apos;t let pests compromise your family&apos;s health or business reputation. Book a professional inspection with our certified Mumbai pest control experts today.
              </p>
      ...
      >
        ...
        <div className="mx-auto max-w-[720px] text-center">
          ...
          >
            ...
            <br />
            <span className="text-[#f4bd00]">in Mumbai</span>
          </h2>
          ...
          <p
            ...
            "
          >
            From persistent termites to pesky cockroaches, bed bugs, and rodents, explore our specialized pest control services in Mumbai tailored for compact apartments, penthouses, restaurants, and commercial towers.
          </p>
        </div>
      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            A systematic, hassle-free approach designed to solve pest problems quickly and keep Mumbai properties protected year-round.
          </p>
        </header>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p
                    ...
                    "
                  >
                    We protect Mumbai homes and commercial facilities with proactive pest management, using safe chemicals that keep your family, pets, and workspace secure.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              >
                <span
                  ...
                  "
                >
                  Need Immediate Assistance in Mumbai?
                </span>
